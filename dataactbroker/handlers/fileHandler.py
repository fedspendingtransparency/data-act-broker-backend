...
class FileHandler:
    ...
    def publish_fabs_submission(submission):
        ...
        FileHandler.move_published_files(FileHandler, submission, publish_history, g.is_local)
    ...
    def move_published_files(self, submission, publish_history, is_local):
        ...
        for job in jobs:
            ...
            file_history = PublishedFilesHistory(publish_history_id=publish_history.publish_history_id,
                                                 certify_history_id=publish_history.publish_history_id,
