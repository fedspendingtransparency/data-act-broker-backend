...
def setupEmails():
    ...
    userDb.loadEmailTemplate("USA Spending Data Broker - Registration",template,"validate_email")
    ...
    userDb.loadEmailTemplate("USA Spending Data Broker - Access Approved",template,"account_approved")
    ...
    userDb.loadEmailTemplate("USA Spending Data Broker - Access Denied",template,"account_rejected")
    ...
    userDb.loadEmailTemplate("USA Spending Data Broker - Password Reset",template,"reset_password")
    ...
    template = "Thank you for registering for a user account with the USA Spending Data Broker. Your information has been sent to your agency's administrator at [EMAIL]. You will receive a response within 24 hours. <br /><br />The DATA Act Implementation Team <br />DATABroker@fiscal.treasury.gov "
    userDb.loadEmailTemplate("USA Spending Data Broker - Registration",template,"account_creation_user")
