...
def test_get_certification_deadline(database):
    ...
    sess = database.session
    quart_sub = SubmissionFactory(
        submission_id=1, reporting_fiscal_year=2020, reporting_fiscal_period=6, is_fabs=False, is_quarter_format=True
    )
    month_sub = SubmissionFactory(
        submission_id=2, reporting_fiscal_year=2020, reporting_fiscal_period=10, is_fabs=False, is_quarter_format=False
    )
    fail_sub = SubmissionFactory(
        submission_id=3, reporting_fiscal_year=2020, reporting_fiscal_period=9, is_fabs=False, is_quarter_format=False
    )
    fabs_sub = SubmissionFactory(
        submission_id=4, reporting_fiscal_year=2020, reporting_fiscal_period=6, is_fabs=True, is_quarter_format=False
    )
...
def test_get_time_period(database):
    ...
    month_sub = SubmissionFactory(
        submission_id=2, reporting_start_date=datetime.datetime(2020, 9, 10), is_fabs=False, is_quarter_format=False
    )
