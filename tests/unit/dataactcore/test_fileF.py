...
def replicate_file_f_results(subaward):
    ...
    return OrderedDict(
        [
            ...
            ("AssistanceListingNumbers", subaward.assistance_listing_numbers),
            ("AssistanceListingTitles", subaward.assistance_listing_titles),
            ...
            ("SubAwardeeOrRecipientUEI", subaward.sub_awardee_or_recipient_uei),
            ...
            ("SubAwardeeUltimateParentUEI", subaward.sub_ultimate_parent_uei),
...
def test_generate_file_f_sql(database, monkeypatch):
    ...
    sub_contracts_show = [
        SubawardFactory(
            id=i, subaward_type="sub-contract", unique_award_key=d1_show.unique_award_key, internal_id=str(i), sub_id=i
        )
        for i in range(0, 5)
    ]
    sub_grants_show = [
        SubawardFactory(
            id=i, subaward_type="sub-grant", unique_award_key=d2_show.unique_award_key, internal_id=str(i), sub_id=i
        )
        for i in range(5, 10)
    ]
    sub_contracts_hide = [
        SubawardFactory(
            id=i, subaward_type="sub-contract", unique_award_key=d1_hide.unique_award_key, internal_id=str(i), sub_id=i
        )
        for i in range(10, 15)
    ]
    sub_grants_hide = [
        SubawardFactory(
            id=i, subaward_type="sub-grant", unique_award_key=d2_hide.unique_award_key, internal_id=str(i), sub_id=i
        )
