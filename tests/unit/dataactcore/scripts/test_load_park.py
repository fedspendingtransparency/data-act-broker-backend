...
def test_export_park(mocked_get_park_file, mocked_get_current_date, mocked_get_stored_date, mocked_set_stored_date,
...
def test_set_get_park_last_upload_existing(monkeypatch, database):
    ...
    function_bag.update_external_data_load_date(datetime.datetime(2017, 12, 31, 0, 0, 0),
                                                datetime.datetime(2017, 12, 31, 0, 0, 0), 'park_upload')
    ...
    function_bag.update_external_data_load_date(datetime.datetime(2016, 12, 31, 0, 0, 0),
                                                datetime.datetime(2016, 12, 31, 0, 0, 0), 'park_upload')
...
@patch('dataactcore.scripts.pipeline.load_park.get_date_of_current_park_upload')
@patch('dataactcore.scripts.pipeline.load_park.get_park_file')
def test_load_park_data(mocked_get_park_file, mocked_get_current_date, mocked_get_stored_date, mocked_set_stored_date,
                        database, monkeypatch):
...
@patch('dataactcore.scripts.pipeline.load_park.get_date_of_current_park_upload')
@patch('dataactcore.scripts.pipeline.load_park.get_park_file')
def test_load_park_data_no_header(mocked_get_park_file, mocked_get_current_date, mocked_get_stored_date,
...
@patch('dataactcore.scripts.pipeline.load_park.get_date_of_current_park_upload')
@patch('dataactcore.scripts.pipeline.load_park.get_park_file')
def test_load_park_data_empty_file(mocked_get_park_file, mocked_get_current_date, mocked_get_stored_date,
                                   mocked_set_stored_date, monkeypatch):
