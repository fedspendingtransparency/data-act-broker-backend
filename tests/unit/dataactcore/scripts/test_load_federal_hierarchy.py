...
def test_load_offices(monkeypatch, database):
    ...
    monkeypatch.setattr(
        "dataactcore.scripts.pipeline.load_federal_hierarchy.get_with_exception_hand", mock_request_to_fh_full
    )
    ...
    metrics_json = {"missing_cgacs": [], "missing_subtier_codes": []}
    load_federal_hierarchy.load_offices(
        sess,
        filename=None,
        update_db=True,
        pull_all=True,
    ...
    monkeypatch.setattr(
        "dataactcore.scripts.pipeline.load_federal_hierarchy.get_with_exception_hand", mock_request_to_fh_update
    )
    load_federal_hierarchy.load_offices(
        sess,
        filename=None,
