...
def test_clean_tas_multiple(tmpdir):
    ...
    results = write_then_read_tas(
        tmpdir,
        {
            ...
            "SUB": "ggg",
            "DT_END": "",
            "DT_TM_ESTAB": "10/1/1987  12:00:00 AM",
            "fr_entity_description": "abcd",
            "fr_entity_type": "1234",
            "gwa_tas_name": "name_6",
            "agency_aid": "bbb",
            "agency_name": "agency_name_6",
        },
        {
            "ACCT_NUM": "12345",
            "ATA": "111",
            ...
            "MAIN": "6666",
            "SUB": "777",
            "DT_END": "12/22/2016  12:00:00 AM",
            "DT_TM_ESTAB": "10/1/2008  12:00:00 AM",
            "fr_entity_description": "xyz",
            "fr_entity_type": "AB12",
            "admin_org": "admin_org_12345",
            "admin_org_name": "admin_org_name_12345",
            "function_code": "800",
            "function_description": "800_desc",
            "sub_function_code": "500",
            "sub_function_description": "500_desc",
        },
    )
...
def test_clean_tas_space_nulls(tmpdir):
    ...
    results = write_then_read_tas(
        tmpdir, {"BPOA": "", "EPOA": " ", "A": "   ", "DT_END": "", "DT_TM_ESTAB": "10/1/2008  12:00:00 AM"}
    )
...
def test_only_fill_missing(database, monkeypatch):
    ...
    existing_tas_entries = [
        ...
        TASFactory(
            account_num=333,
            **{field: "333" for field in TAS_COMPONENTS},
