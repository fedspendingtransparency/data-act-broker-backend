...
def test_success(database):
    ...
    """
    fabs_1 = FABSFactory(
        legal_entity_country_code="USA", legal_entity_congressional=None, correction_delete_indicatr="C"
    )
    fabs_2 = FABSFactory(
        legal_entity_country_code="usA", legal_entity_congressional="", correction_delete_indicatr=None
    )
    fabs_3 = FABSFactory(
        legal_entity_country_code="USA", legal_entity_congressional="01", correction_delete_indicatr="D"
    )
    ...
    fabs_6 = FABSFactory(
        legal_entity_country_code="ABC", legal_entity_congressional="01", correction_delete_indicatr="d"
    )
...
def test_failure(database):
    ...
    fabs_1 = FABSFactory(
        legal_entity_country_code="AbC", legal_entity_congressional="02", correction_delete_indicatr="C"
    )
