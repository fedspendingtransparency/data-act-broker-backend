...
def test_column_headers(database):
    expected = {
        'uniqueid_TAS', 'uniqueid_DisasterEmergencyFundCode', 'row_number', 'allocation_transfer_agency',
        'agency_identifier', 'beginning_period_of_availa', 'ending_period_of_availabil',
        'availability_type_code', 'main_account_code', 'sub_account_code', 'disaster_emergency_fund_code'
    }
...
def test_financing_tas(database):
    ...
    gtas_3 = SF133Factory(tas_id=cars_3.account_num, allocation_transfer_agency=None, disaster_emergency_fund_code='N')
    ...
    submission = SubmissionFactory(reporting_fiscal_period=gtas_3.period, reporting_fiscal_year=gtas_3.fiscal_year,
                                   cgac_code=gtas_3.agency_identifier, is_quarter_format=False)
