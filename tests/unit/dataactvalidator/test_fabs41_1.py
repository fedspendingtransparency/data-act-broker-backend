...
def test_success(database):
    ...
    fabs_11 = FABSFactory(place_of_performance_code='Ny1098t', place_of_performance_zip4a='city-wide',
                          correction_delete_indicatr='')
    fabs_12 = FABSFactory(place_of_performance_code='Ny1098T', place_of_performance_zip4a=None,
                          correction_delete_indicatr='c')

    # Testing with TS center
    fabs_13 = FABSFactory(place_of_performance_code='Nyts123', place_of_performance_zip4a='city-wide',
                          correction_delete_indicatr='')
    fabs_14 = FABSFactory(place_of_performance_code='NyTs123', place_of_performance_zip4a=None,
                          correction_delete_indicatr='c')

    # Ignore correction delete indicator of D
    fabs_15 = FABSFactory(place_of_performance_code='ny10986', place_of_performance_zip4a=None,
                          correction_delete_indicatr='d')
    errors = number_of_errors(_FILE, database, models=[fabs_1, fabs_2, fabs_3, fabs_4, fabs_5, fabs_6, fabs_7, fabs_8,
                                                       fabs_9, fabs_10, fabs_11, fabs_12, fabs_13, fabs_14, fabs_15,
                                                       city_code, city_code_2, city_code_3, city_code_4])
    assert errors == 0
...
def test_failure(database):
    ...
    fabs_4 = FABSFactory(place_of_performance_code='na1098R', place_of_performance_zip4a=None,
                         correction_delete_indicatr='C')
    fabs_5 = FABSFactory(place_of_performance_code='na1098t', place_of_performance_zip4a=None,
                         correction_delete_indicatr='C')
    fabs_6 = FABSFactory(place_of_performance_code='naTS123', place_of_performance_zip4a=None,
                         correction_delete_indicatr='C')
