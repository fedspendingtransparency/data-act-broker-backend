...
def test_success(database):
    ...
    fabs_4 = FABSFactory(
        legal_entity_zip5="", legal_entity_congressional="05", correction_delete_indicatr="C", action_date="20230102"
    )

    # Test ignore null CDs
    fabs_5 = FABSFactory(
        legal_entity_zip5="12345", legal_entity_congressional="", correction_delete_indicatr="", action_date="20230102"
    )
    fabs_6 = FABSFactory(
        legal_entity_zip5="", legal_entity_congressional="", correction_delete_indicatr="c", action_date="20230102"
    )
    fabs_7 = FABSFactory(
        legal_entity_zip5="12345",
