...
def test_success(database):
    ...
    fabs_6 = FABSFactory(
        awarding_office_code="", action_type=None, action_date="10/01/2018", correction_delete_indicatr=""
    )
    fabs_7 = FABSFactory(
        awarding_office_code=None, action_type=None, action_date="10/02/2018", correction_delete_indicatr="C"
    )
