...
def test_success(database):
    ...
    award_fin = AwardFinancialFactory(gross_outlays_undelivered_fyb=value_one, ussgl480200_undelivered_or_fyb=value_one)
    award_fin_null = AwardFinancialFactory(gross_outlays_undelivered_fyb=0, ussgl480200_undelivered_or_fyb=None)
...
def test_failure(database):
    ...
    award_fin = AwardFinancialFactory(gross_outlays_undelivered_fyb=value_one, ussgl480200_undelivered_or_fyb=value_two)
