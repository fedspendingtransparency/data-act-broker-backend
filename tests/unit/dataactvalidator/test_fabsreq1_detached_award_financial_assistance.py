...
def test_column_headers(database):
    expected_subset = {'row_number', 'award_description', 'correction_delete_indicatr', 'uniqueid_afa_generated_unique'}
...
def test_success(database):
    ...
    det_award_5 = DetachedAwardFinancialAssistanceFactory(correction_delete_indicatr='D', award_description='Yes')
