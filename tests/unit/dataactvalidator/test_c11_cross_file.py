...
def test_success(database):
    ...
    af = AwardFinancialFactory(
        piid="some_pIId", parent_award_id=None, allocation_transfer_agency=None, transaction_obligated_amou="12345"
    )
    ...
    af = AwardFinancialFactory(
        piid=None, parent_award_id=None, allocation_transfer_agency=None, transaction_obligated_amou="12345"
    )
    ap = AwardProcurementFactory(piid="some_pIId", parent_award_id="some_other_parent_awARd_id")
