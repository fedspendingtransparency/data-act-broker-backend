...
def test_success(database):
    ...
    award_fin = AwardFinancialFactory(
        gross_outlays_delivered_or_fyb=value_one, ussgl490800_authority_outl_fyb=value_one
    )
    award_fin_null = AwardFinancialFactory(gross_outlays_delivered_or_fyb=0, ussgl490800_authority_outl_fyb=None)
...
def test_failure(database):
    ...
    award_fin = AwardFinancialFactory(
        gross_outlays_delivered_or_fyb=value_one, ussgl490800_authority_outl_fyb=value_two
    )
