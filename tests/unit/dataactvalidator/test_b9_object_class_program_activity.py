...
def test_success(database):
    ...
    op_3 = ObjectClassProgramActivityFactory(
        row_number=3,
        submission_id=1,
        agency_identifier="fail",
        main_account_code="test",
        program_activity_name="",
        program_activity_code=None,
    )

    pa = ProgramActivityFactory(
        fiscal_year_period="FY16P12",
        agency_id="test",
...
def test_success_fiscal_year_period(database):
    """Testing valid name for FY that matches with fiscal_year_period"""
...
def test_failure_fiscal_year_period(database):
    """Testing invalid program activity, does not match with fiscal_year_period"""
...
def test_failure_empty_activity_name(database):
    ...
    op = ObjectClassProgramActivityFactory(
        ...
        program_activity_name="",
        program_activity_code="test",
        deobligations_recov_by_pro_cpe=2,
        gross_outlay_amount_by_pro_cpe=0,
        gross_outlay_amount_by_pro_fyb=0,
        gross_outlays_delivered_or_cpe=0,
        gross_outlays_delivered_or_fyb=0,
    ...
    op = ObjectClassProgramActivityFactory(
        ...
        gross_outlays_undelivered_fyb=0,
        obligations_delivered_orde_cpe=0,
        obligations_delivered_orde_fyb=-2,
        obligations_incurred_by_pr_cpe=0,
        obligations_undelivered_or_cpe=0,
        obligations_undelivered_or_fyb=0,
        ussgl480100_undelivered_or_cpe=0,
        ...
        ussgl480110_rein_undel_ord_cpe=0,
        ussgl480200_undelivered_or_cpe=0,
        ussgl480200_undelivered_or_fyb=-0.4,
        ussgl480210_rein_undel_obs_cpe=0,
        ussgl483100_undelivered_or_cpe=0,
        ussgl483200_undelivered_or_cpe=0,
        ussgl487100_downward_adjus_cpe=0.4,
        ussgl487200_downward_adjus_cpe=0,
        ussgl488100_upward_adjustm_cpe=0,
        ussgl488200_upward_adjustm_cpe=0,
        ussgl490100_delivered_orde_cpe=0,
    ...
    op = ObjectClassProgramActivityFactory(
        ...
        program_activity_code="test",
        deobligations_recov_by_pro_cpe=2,
        gross_outlay_amount_by_pro_cpe=100,
        gross_outlay_amount_by_pro_fyb=-0.00003,
        gross_outlays_delivered_or_cpe=10,
        gross_outlays_delivered_or_fyb=5,
        gross_outlays_undelivered_cpe=5,
        gross_outlays_undelivered_fyb=5,
        obligations_delivered_orde_cpe=5,
        obligations_delivered_orde_fyb=-2,
        obligations_incurred_by_pr_cpe=5,
        obligations_undelivered_or_cpe=5,
        obligations_undelivered_or_fyb=5,
        ussgl480100_undelivered_or_cpe=5,
        ussgl480100_undelivered_or_fyb=5,
        ussgl480110_rein_undel_ord_cpe=5,
        ussgl480200_undelivered_or_cpe=5,
        ussgl480200_undelivered_or_fyb=-0.4,
        ussgl480210_rein_undel_obs_cpe=0,
        ussgl483100_undelivered_or_cpe=5,
        ussgl483200_undelivered_or_cpe=5,
        ussgl487100_downward_adjus_cpe=0.4,
        ussgl487200_downward_adjus_cpe=5,
        ussgl488100_upward_adjustm_cpe=5,
        ussgl488200_upward_adjustm_cpe=5,
        ussgl490100_delivered_orde_cpe=5,
        ussgl490100_delivered_orde_fyb=5,
        ussgl490110_rein_deliv_ord_cpe=5,
        ussgl490200_delivered_orde_cpe=5,
        ussgl490800_authority_outl_cpe=5,
        ussgl490800_authority_outl_fyb=5,
        ussgl493100_delivered_orde_cpe=5,
        ussgl497100_downward_adjus_cpe=5,
        ussgl497200_downward_adjus_cpe=5,
        ussgl497210_down_adj_refun_cpe=0,
        ussgl498100_upward_adjustm_cpe=5,
        ussgl498200_upward_adjustm_cpe=5,
    )
