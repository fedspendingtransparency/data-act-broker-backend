...
def test_success(database):
    ...
    fabs_3 = FABSFactory(
        period_of_performance_star=None, period_of_performance_curr="20120724", correction_delete_indicatr="d"
    )
...
def test_failure(database):
    ...
    """
    fabs_1 = FABSFactory(
        period_of_performance_star=None, period_of_performance_curr="20120724", correction_delete_indicatr=""
    )
    fabs_2 = FABSFactory(
        period_of_performance_star="20120725", period_of_performance_curr=None, correction_delete_indicatr="C"
    )
