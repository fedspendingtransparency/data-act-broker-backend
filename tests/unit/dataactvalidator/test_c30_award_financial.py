...
def test_column_headers(database):
    expected_subset = {'row_number', 'ussgl487200_downward_adjus_cpe', 'ussgl497200_downward_adjus_cpe', 'uniqueid_TAS',
...
def test_success_pre_25(database):
    ...
    af1 = AwardFinancialFactory(submission_id=sub_id, ussgl487200_downward_adjus_cpe=5,
                                ussgl497200_downward_adjus_cpe=None, transaction_obligated_amou=None)
    af2 = AwardFinancialFactory(submission_id=sub_id, ussgl487200_downward_adjus_cpe=None,
                                ussgl497200_downward_adjus_cpe=4, transaction_obligated_amou=None)
    af3 = AwardFinancialFactory(submission_id=sub_id, ussgl487200_downward_adjus_cpe=None,
                                ussgl497200_downward_adjus_cpe=None, transaction_obligated_amou=None)
    af4 = AwardFinancialFactory(submission_id=sub_id, ussgl487200_downward_adjus_cpe=5,
                                ussgl497200_downward_adjus_cpe=2, transaction_obligated_amou=6)
...
def test_success_post_25(database):
    ...
    # All contain data
    af1 = AwardFinancialFactory(submission_id=sub_id, ussgl487200_downward_adjus_cpe=5,
                                ussgl497200_downward_adjus_cpe=4, transaction_obligated_amou=3)
