...
def test_success(database):
    ...
    fabs_4 = FABSFactory(place_of_performance_code=None, place_of_performance_zip4a='4312', record_type=2,
                         correction_delete_indicatr='C')
    fabs_5 = FABSFactory(place_of_performance_code='ny**987', place_of_performance_zip4a=None, record_type=2,
                         correction_delete_indicatr='')
    fabs_6 = FABSFactory(place_of_performance_code='00*****', place_of_performance_zip4a='', record_type=1,
                         correction_delete_indicatr='')
    fabs_7 = FABSFactory(place_of_performance_code='00*****', place_of_performance_zip4a='abcde', record_type=3,
                         correction_delete_indicatr='')
    # Ignore correction delete indicator of D
    fabs_8 = FABSFactory(place_of_performance_code='00FORGN', place_of_performance_zip4a='1234', record_type=1,
