...
def test_success(database):
    ...
    fabs_2 = FABSFactory(
        place_of_performance_code="ny98765",
        place_of_performance_zip4a="4312",
        record_type=1,
        correction_delete_indicatr=None,
    )
    fabs_3 = FABSFactory(
        place_of_performance_code="ny9876R",
        place_of_performance_zip4a="4312",
        record_type=1,
        correction_delete_indicatr="c",
    )
    fabs_4 = FABSFactory(
        place_of_performance_code="ny9876t",
        place_of_performance_zip4a="4312",
        record_type=1,
        correction_delete_indicatr="c",
    )
    fabs_5 = FABSFactory(
        place_of_performance_code="nytS987",
        place_of_performance_zip4a="4312",
        record_type=1,
        correction_delete_indicatr="c",
    )
    ...
    fabs_9 = FABSFactory(
        ...
        place_of_performance_zip4a="abcde",
        record_type=3,
        correction_delete_indicatr="",
    )
    ...
    errors = number_of_errors(
        _FILE, database, models=[fabs_1, fabs_2, fabs_3, fabs_4, fabs_5, fabs_6, fabs_7, fabs_8, fabs_9, fabs_10]
    )
    assert errors == 0
