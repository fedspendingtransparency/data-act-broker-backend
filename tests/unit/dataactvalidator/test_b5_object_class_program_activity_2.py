...
def test_column_headers(database):
    expected_subset = {'row_number', 'gross_outlay_amount_by_pro_cpe', 'gross_outlays_undelivered_cpe',
                       'gross_outlays_delivered_or_cpe', 'difference', 'uniqueid_TAS', 'uniqueid_DEFC',
...
def test_success(database):
    """ Tests that Object Class Program activity gross_outlays_delivered_or_cpe + gross_outlays_undelivered_cpe
        equals gross_outlay_amount_by_pro_cpe for the same date context and TAS/DEFC combination
    """
...
def test_failure(database):
    """ Tests that Object Class Program activity gross_outlays_delivered_or_cpe + gross_outlays_undelivered_cpe
        doesn't equal gross_outlay_amount_by_pro_cpe for the same date context and TAS/DEFC combination
    """
