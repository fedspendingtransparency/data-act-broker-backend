...
def test_equal_fain(database):
    ...
    afa = AwardFinancialAssistanceFactory(
        tas=tas, submisson_id=af.submission_id, fain="aBc", uri=None, allocation_transfer_agency=None, record_type="2"
    )
...
def test_equal_uri(database):
    ...
    afa = AwardFinancialAssistanceFactory(
        tas=tas, submisson_id=af.submission_id, fain=None, uri="xYz", allocation_transfer_agency=None, record_type="1"
    )
...
def test_null_uri_fain(database):
    ...
    afa = AwardFinancialAssistanceFactory(
        tas=tas, submission_id=af.submission_id, fain=None, uri=None, allocation_transfer_agency=None
    )
...
def test_non_matching_aggregate_uri(database):
    ...
    af = AwardFinancialFactory(tas=tas, fain="abc", uri=None, allocation_transfer_agency=None)
    afa = AwardFinancialAssistanceFactory(
        tas=tas, submisson_id=af.submission_id, fain="aBc", uri="xYz", allocation_transfer_agency=None, record_type="3"
    )
...
def test_non_matching_non_aggregate_fain(database):
    ...
    af = AwardFinancialFactory(tas=tas, fain=None, uri="xyz", allocation_transfer_agency=None)
    afa = AwardFinancialAssistanceFactory(
        tas=tas, submisson_id=af.submission_id, fain="aBc", uri="xYz", allocation_transfer_agency=None, record_type="1"
    )
...
def test_unequal_fain(database):
    ...
    af = AwardFinancialFactory(tas=tas, fain="abc", uri=None, allocation_transfer_agency=None)
    afa = AwardFinancialAssistanceFactory(
        tas=tas, submission_id=af.submission_id, fain="xyz", uri=None, allocation_transfer_agency=None, record_type="2"
    )
...
def test_unequal_uri(database):
    ...
    afa = AwardFinancialAssistanceFactory(
        tas=tas, submission_id=af.submission_id, fain=None, uri="xyz", allocation_transfer_agency=None, record_type="1"
    )
...
def test_unequal_fain_null(database):
    ...
    af = AwardFinancialFactory(tas=tas, fain="abc", uri=None, allocation_transfer_agency=None)
    afa = AwardFinancialAssistanceFactory(
        tas=tas, submission_id=af.submission_id, fain=None, uri=None, allocation_transfer_agency=None, record_type="3"
    )
...
def test_unequal_uri_null(database):
    ...
    afa_1 = AwardFinancialAssistanceFactory(
        tas=tas, submission_id=af.submission_id, fain=None, uri="abc", allocation_transfer_agency=None, record_type="1"
    )
    afa_2 = AwardFinancialAssistanceFactory(
        tas=tas, submission_id=af.submission_id, fain="abc", uri=None, allocation_transfer_agency=None, record_type="3"
    )
...
def test_matching_allocation_transfer_agency(database):
    ...
    afa = AwardFinancialAssistanceFactory(
        tas=tas, submission_id=af.submission_id, fain="123", uri=None, allocation_transfer_agency=None, record_type="2"
    )
...
def test_ignore_when_different_ata(database):
    ...
    afa = AwardFinancialAssistanceFactory(
        tas=tas, submission_id=af.submission_id, fain="123", uri=None, allocation_transfer_agency=None, record_type="3"
    )
