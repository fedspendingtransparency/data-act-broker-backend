...
def test_column_headers(database):
    expected_subset = {
        ...
        "expected_value_GTAS SF133 Line 3020",
        "difference",
    }
...
def test_success(database):
    ...
    ap = Appropriation(job_id=1, row_number=1, display_tas=tas, gross_outlay_amount_by_tas_cpe=1)
    ...
    ap = Appropriation(job_id=1, row_number=1, display_tas="tas_no_sf", gross_outlay_amount_by_tas_cpe=0)
...
def test_failure(database):
    ...
    ap = Appropriation(job_id=1, row_number=1, display_tas=tas, gross_outlay_amount_by_tas_cpe=0)
    ap_2 = Appropriation(job_id=1, row_number=1, display_tas="tas_no_sf", gross_outlay_amount_by_tas_cpe=10)
