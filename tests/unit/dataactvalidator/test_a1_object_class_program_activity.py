...
def test_success(database):
    ...
    approp = ObjectClassProgramActivityFactory(allocation_transfer_agency = tas.allocation_transfer_agency,
    ...
    approp_null = ObjectClassProgramActivityFactory(allocation_transfer_agency = None,
