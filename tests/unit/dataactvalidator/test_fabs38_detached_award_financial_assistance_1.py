...
def test_success(database):
    """ Test FundingOfficeCode must be submitted for new awards (ActionType = A or blank) whose ActionDate is on or
...
def test_failure(database):
    """ Test failure FundingOfficeCode must be submitted for new awards (ActionType = A or blank) whose ActionDate is
