...
_FILE = 'fabs38_detached_award_financial_assistance_1'
...
def test_success(database):
    ...
    det_award_2 = DetachedAwardFinancialAssistanceFactory(funding_office_code='111111', action_type='a',
                                                          action_date='10/01/2018', correction_delete_indicatr='C')

    # Rule ignored for earlier dates
    det_award_3 = DetachedAwardFinancialAssistanceFactory(funding_office_code='', action_type='E',
    ...
    det_award_5 = DetachedAwardFinancialAssistanceFactory(funding_office_code=None, action_type='E',
                                                          action_date='10/01/2018', correction_delete_indicatr='D')

    # Rule ignored for action_type of None
    det_award_6 = DetachedAwardFinancialAssistanceFactory(funding_office_code='', action_type=None,
                                                          action_date='10/01/2018', correction_delete_indicatr='')
    det_award_7 = DetachedAwardFinancialAssistanceFactory(funding_office_code=None, action_type=None,
...
def test_failure(database):
    ...
    det_award_1 = DetachedAwardFinancialAssistanceFactory(funding_office_code='', action_type='A',
                                                          action_date='10/01/2018', correction_delete_indicatr='')
    det_award_2 = DetachedAwardFinancialAssistanceFactory(funding_office_code=None, action_type='E',
                                                          action_date='10/02/2018', correction_delete_indicatr='C')
