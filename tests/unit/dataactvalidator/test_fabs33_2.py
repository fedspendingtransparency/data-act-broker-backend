...
def test_success(database):
    ...
    """
    fabs_1 = FABSFactory(period_of_performance_curr='20120725', correction_delete_indicatr='')
    fabs_2 = FABSFactory(period_of_performance_curr=None, correction_delete_indicatr=None)
    fabs_3 = FABSFactory(period_of_performance_curr='5', correction_delete_indicatr='c')
    fabs_4 = FABSFactory(period_of_performance_curr='', correction_delete_indicatr='C')
    # Ignore correction delete indicator of D
    fabs_5 = FABSFactory(period_of_performance_curr='19990131', correction_delete_indicatr='d')
