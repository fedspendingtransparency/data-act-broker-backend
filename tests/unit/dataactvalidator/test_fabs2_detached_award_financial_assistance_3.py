...
_FILE = 'fabs2_detached_award_financial_assistance_3'
...
def test_success(database):
    """ The unique combination of FAIN, AwardModificationAmendmentNumber, URI, and AwardingSubTierAgencyCode must exist
        as a currently published record when the record is a correction (i.e., if CorrectionLateDeleteIndicator = C).
