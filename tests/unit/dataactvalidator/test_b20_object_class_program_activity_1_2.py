...
_FILE = 'b20_object_class_program_activity_1_2'
...
def test_column_headers(database):
    expected_subset = {'source_row_number', 'source_value_TAS', 'source_value_program_activity_code',
                       ...
                       'source_value_disaster_emergency_fund_code', 'uniqueid_TAS', 'uniqueid_ProgramActivityCode',
                       'uniqueid_ProgramActivityName', 'uniqueid_ObjectClass', 'uniqueid_DisasterEmergencyFundCode'}
...
def test_success(database):
    """
        ...
        combination where PYA = X or NULL in File C to be a subset of those provided in File B. If PYA is not provided
        in File C, the combination of TAS, PAC/PAN, object class, and DEFC is applied.
    """
    tas = TASFactory()
    tas2 = TASFactory()
    ...
    af = AwardFinancialFactory(account_num=tas.account_num, program_activity_code='1', program_activity_name='PA1',
                               object_class='1', disaster_emergency_fund_code='s', prior_year_adjustment=None)
    ...
    af2 = AwardFinancialFactory(account_num=tas.account_num, program_activity_code='', program_activity_name='Pa1',
                                object_class='1', disaster_emergency_fund_code='S', prior_year_adjustment='')
    ...
    af7 = AwardFinancialFactory(account_num=tas2.account_num, program_activity_code='2', program_activity_name='pa2',
                                object_class='00', disaster_emergency_fund_code='s', prior_year_adjustment=None)
    ...
    af9 = AwardFinancialFactory(account_num=tas.account_num, program_activity_code='', program_activity_name=None,
                                object_class='9', disaster_emergency_fund_code='s', prior_year_adjustment='')

    assert number_of_errors(_FILE, database, models=[op, op2, af, af2, af3, af4, af5, af6, af7, af8, af9]) == 0
...
def test_failure(database):
    ...
    af4 = AwardFinancialFactory(account_num=tas1.account_num, program_activity_code='1', program_activity_name='PA1',
                                object_class='2', disaster_emergency_fund_code='s', prior_year_adjustment=None)
    # Different DEFC
    af5 = AwardFinancialFactory(account_num=tas1.account_num, program_activity_code='1', program_activity_name='PA1',
                                object_class='1', disaster_emergency_fund_code='t', prior_year_adjustment='')
    ...
    af6 = AwardFinancialFactory(account_num=tas2.account_num, program_activity_code='1', program_activity_name='PA1',
                                object_class='0', disaster_emergency_fund_code='s', prior_year_adjustment=None)
    ...
    assert number_of_errors(_FILE, database, models=[op, op2, af1, af2, af3, af4, af5, af6, af7, af8]) == 8
