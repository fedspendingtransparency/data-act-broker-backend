...
_FILE = 'fabs13_detached_award_financial_assistance_2'


def test_column_headers(database):
    expected_subset = {'row_number', 'legal_entity_country_code', 'legal_entity_zip5', 'uniqueid_afa_generated_unique'}
...
def test_success(database):
    ...
    det_award_4 = DetachedAwardFinancialAssistanceFactory(legal_entity_country_code='UK', legal_entity_zip5='Test',
