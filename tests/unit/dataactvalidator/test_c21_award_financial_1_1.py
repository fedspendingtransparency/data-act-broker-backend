...
def test_column_headers(database):
    expected_subset = {
        ...
        'source_value_ussgl480110_reinstated_del_cpe_sum_c',
        ...
        'source_value_ussgl490110_reinstated_del_cpe_sum_c',
        ...
        'target_value_ussgl480110_reinstated_del_cpe_sum_b',
        ...
        'target_value_ussgl490110_reinstated_del_cpe_sum_b',
...
def test_success(database):
    ...
    """
    af_dict_null_pya = dict(**af_dict)
    af_dict_null_pya['tas'] = 'null_pya_tas'
    af_dict_null_pya['prior_year_adjustment'] = None
    ...
    af3 = AwardFinancialFactory(**af_dict_null_pya)
    ...
    # Ignored because PYA is NULL
    op5 = ObjectClassProgramActivityFactory(**af_dict_null_pya)
...
def test_failure(database):
    ...
    op2 = ObjectClassProgramActivityFactory(
        ...
        ussgl480110_reinstated_del_cpe=af_dict_null_pac['ussgl480110_reinstated_del_cpe'] + 1,
        ...
        ussgl490110_reinstated_del_cpe=af_dict_null_pac['ussgl490110_reinstated_del_cpe'] + 1,
    ...
    op3 = ObjectClassProgramActivityFactory(
        ...
        ussgl480110_reinstated_del_cpe=af_dict_null_pan['ussgl480110_reinstated_del_cpe'] + 1,
        ...
        ussgl490110_reinstated_del_cpe=af_dict_null_pan['ussgl490110_reinstated_del_cpe'] + 1,
