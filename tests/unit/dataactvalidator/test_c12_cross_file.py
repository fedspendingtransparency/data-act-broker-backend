...
def test_success(database):
    ...
    ap = AwardProcurementFactory(
        piid="some_piid", parent_award_id="some_PArent_award_id", federal_action_obligation=None
    )
...
def test_failure(database):
    ...
    af = AwardFinancialFactory(
        piid="some_other_piid", parent_award_id="some_pARent_award_id", transaction_obligated_amou=1
    )
    ...
    ap = AwardProcurementFactory(piid="some_piid", parent_award_id="some_Parent_award_id", federal_action_obligation=1)
    af = AwardFinancialFactory(
        piid="some_pIId", parent_award_id="some_other_parenT_award_id", transaction_obligated_amou=1
    )
    ...
    ap = AwardProcurementFactory(piid="some_pIId", parent_award_id="some_PArent_award_id", federal_action_obligation=1)
    af = AwardFinancialFactory(
        piid="some_piid", parent_award_id="some_parent_AWard_id", transaction_obligated_amou=None
    )
