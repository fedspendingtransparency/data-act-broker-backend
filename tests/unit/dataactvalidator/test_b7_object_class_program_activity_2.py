...
def test_column_headers(database):
    expected_subset = {'row_number', 'prior_year_adjustment', 'gross_outlays_delivered_or_cpe',
                       'ussgl490200_delivered_orde_cpe', 'ussgl490800_authority_outl_cpe',
                       'ussgl498200_upward_adjustm_cpe', 'difference', 'uniqueid_TAS',
...
def test_success(database):
    ...
    op2 = ObjectClassProgramActivityFactory(gross_outlays_delivered_or_cpe=0, ussgl490200_delivered_orde_cpe=1,
                                            ussgl490800_authority_outl_cpe=1, ussgl498200_upward_adjustm_cpe=1,
