...
def test_success(database):
    ...
    af1 = AwardFinancialFactory(
        program_activity_reporting_key="aBcD", program_activity_code="342", program_activity_name="Test"
    )
...
def test_failure(database):
    ...
    af3 = AwardFinancialFactory(
        program_activity_reporting_key="", program_activity_code="1234", program_activity_name=""
    )
    af4 = AwardFinancialFactory(
        program_activity_reporting_key="", program_activity_code="", program_activity_name="Test"
    )
