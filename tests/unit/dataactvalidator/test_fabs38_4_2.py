...
def test_success_ignore_null_pub_fabs(database):
    ...
    fabs_1 = FABSFactory(awarding_office_code='', unique_award_key='zyxwv_123', action_date='20181020',
    ...
    fabs_2 = FABSFactory(awarding_office_code='abd', unique_award_key='abcd_123', action_date='20181020',
                         award_modification_amendme='1', correction_delete_indicatr=None)
    # New entry for valid awarding office
    fabs_3 = FABSFactory(awarding_office_code=None, unique_award_key='1234_abc', action_date='20181020',
                         award_modification_amendme='1', correction_delete_indicatr=None)
    # Correction to base record (ignore)
    fabs_4 = FABSFactory(awarding_office_code='', unique_award_key='abcd_123', action_date='20181019',
                         award_modification_amendme='0', correction_delete_indicatr='C')
    # New entry for earliest inactive
    fabs_5 = FABSFactory(awarding_office_code='', unique_award_key='4321_cba', action_date='20181020',
                         award_modification_amendme='2', correction_delete_indicatr=None)
...
def test_failure_invalid_offices(database):
    ...
    fabs_2 = FABSFactory(awarding_office_code='', unique_award_key='zyxwv_123', action_date='20181020',
                         award_modification_amendme=None, correction_delete_indicatr=None)
    # New entry for earliest inactive
    fabs_3 = FABSFactory(awarding_office_code='', unique_award_key='4321_cba', action_date='20181020',
                         award_modification_amendme='2', correction_delete_indicatr=None)
    # New entry for has valid non-awarding code
    fabs_4 = FABSFactory(awarding_office_code='', unique_award_key='123_abc', action_date='20181020',
                         award_modification_amendme='2', correction_delete_indicatr=None)
    # Entry for award_modification_amendme null in base record
    fabs_5 = FABSFactory(awarding_office_code='', unique_award_key='zyxwv_1234', action_date='20181020',
                         award_modification_amendme='2', correction_delete_indicatr=None)
...
def test_failure_invalid_dates(database):
    ...
    pub_fabs_1 = PublishedFABSFactory(awarding_office_code='12345a', unique_award_key='zyx_123', action_date='20171018',
                                      award_modification_amendme='0', is_active=True)
    # Action date too late
    pub_fabs_2 = PublishedFABSFactory(awarding_office_code='12345a', unique_award_key='4321_cba',
                                      action_date='20181018', award_modification_amendme='0', is_active=True)

    # Entry for action date too early
    fabs_1 = FABSFactory(awarding_office_code='', unique_award_key='zyx_123', action_date='20201020',
                         award_modification_amendme='2', correction_delete_indicatr=None)
    # Entry for action date too late
    fabs_2 = FABSFactory(awarding_office_code='', unique_award_key='4321_cba', action_date='20201020',
                         award_modification_amendme=None, correction_delete_indicatr=None)
