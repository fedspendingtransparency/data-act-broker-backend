...
def test_failure(database):
    ...
    fabs = FABSFactory(legal_entity_country_code='UsA', legal_entity_foreign_posta='12345', record_type=2,
                       correction_delete_indicatr='')
    fabs_2 = FABSFactory(legal_entity_country_code='UKR', legal_entity_foreign_posta='12345', record_type=1,
                         correction_delete_indicatr='c')
