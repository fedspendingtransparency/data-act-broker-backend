...
def test_success(database):
    ...
    approp = AppropriationFactory(
        status_of_budgetary_resour_cpe=300, obligations_incurred_total_cpe=100, unobligated_balance_cpe=200
    )
    approp_null = AppropriationFactory(
        status_of_budgetary_resour_cpe=100, obligations_incurred_total_cpe=100, unobligated_balance_cpe=None
    )
...
def test_failure(database):
    ...
    approp = AppropriationFactory(
        status_of_budgetary_resour_cpe=500, obligations_incurred_total_cpe=100, unobligated_balance_cpe=200
    )
    approp_null = AppropriationFactory(
        status_of_budgetary_resour_cpe=300, obligations_incurred_total_cpe=100, unobligated_balance_cpe=None
    )
