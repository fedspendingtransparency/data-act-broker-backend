...
def test_success(database):
    ...
    fabs_2 = FABSFactory(place_of_performance_code='ny*****', place_of_performance_congr='02',
                         correction_delete_indicatr=None, action_date='20230104')
    fabs_3 = FABSFactory(place_of_performance_code='Ny12345', place_of_performance_congr='03',
                         correction_delete_indicatr='c', action_date='20230104')
    ...
    fabs_9 = FABSFactory(place_of_performance_code='', place_of_performance_congr='04', correction_delete_indicatr='',
    ...
    fabs_12 = FABSFactory(place_of_performance_code='nY12345', place_of_performance_congr='09',
                          correction_delete_indicatr='d', action_date='20230104')

    errors = number_of_errors(_FILE, database, models=[fabs_1, fabs_2, fabs_3, fabs_4, fabs_5, fabs_6, fabs_7, fabs_8,
                                                       fabs_9, fabs_10, fabs_11, fabs_12, state_congr_1, state_congr_2,
                                                       state_congr_3])
    assert errors == 0
