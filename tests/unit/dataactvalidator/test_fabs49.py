...
def test_column_headers(database):
    expected_subset = {'row_number', 'awarding_sub_tier_agency_c', 'derived_awarding_agency_code',
                       'expected_value_Derived AwardingAgencyCode', 'uniqueid_AssistanceTransactionUniqueKey'}
...
def test_failure_frec(database):
    ...
    errors = number_of_errors(_FILE, database, models=[fabs_1, fabs_2, frec_cgac, frec, frec_subtier],
                              submission=frec_submission)
    assert errors == 2
