...
def test_success(database):
    ...
    af_1_row_1 = AwardFinancialFactory(
        ...
        piid=piid.lower(),
        parent_award_id=paid_1.lower(),
        allocation_transfer_agency=None,
    )
    af_1_row_2 = AwardFinancialFactory(
        transaction_obligated_amou=11, piid=piid, parent_award_id=paid_1, allocation_transfer_agency=None
    )
    # next 2 rows ignored because they don't have a PIID
    af_1_row_3 = AwardFinancialFactory(
        transaction_obligated_amou=11, piid=None, parent_award_id=paid_1, allocation_transfer_agency=None
    )
    ...
    af_2_row_1 = AwardFinancialFactory(
        transaction_obligated_amou=9900, piid=piid, parent_award_id=paid_2, allocation_transfer_agency=None
    )
    af_2_row_2 = AwardFinancialFactory(
        transaction_obligated_amou=99,
        piid=piid.lower(),
        parent_award_id=paid_2.lower(),
        allocation_transfer_agency="good",
    ...
    af_4 = AwardFinancialFactory(
        ...
        piid=piid.lower(),
        parent_award_id=paid_4,
        allocation_transfer_agency="good",
        agency_identifier="good",
    )

    # Combine these to match paid_1
    ap_1_row_1 = AwardProcurementFactory(
        parent_award_id=paid_1.lower(), piid=piid.lower(), federal_action_obligation=-1100
    )
...
def test_failure(database):
    ...
    af_2_row_1 = AwardFinancialFactory(
        transaction_obligated_amou=1111, piid=piid, parent_award_id=paid_2.lower(), allocation_transfer_agency=None
    )
    af_2_row_2 = AwardFinancialFactory(
        transaction_obligated_amou=1111,
        piid=piid.lower(),
        parent_award_id=paid_2,
        allocation_transfer_agency="good",
        agency_identifier="good",
    )
