...
def test_success(database):
    ...
    op1 = ObjectClassProgramActivityFactory(
        display_tas="abcde",
        object_class="1",
        program_activity_reporting_key="1a",
    ...
    op4 = ObjectClassProgramActivityFactory(
        display_tas="abcde",
        object_class="1",
        program_activity_reporting_key="1b",
        by_direct_reimbursable_fun="r",
        disaster_emergency_fund_code="n",
        prior_year_adjustment="x",
    )
    ...
    op6 = ObjectClassProgramActivityFactory(
        display_tas="abcde",
        object_class="1",
        program_activity_reporting_key="1a",
        by_direct_reimbursable_fun="r",
    ...
    op7 = ObjectClassProgramActivityFactory(
        display_tas="abcde",
        object_class="1",
        program_activity_reporting_key="1a",
        by_direct_reimbursable_fun="r",
    ...
    op8 = ObjectClassProgramActivityFactory(
        display_tas="abcde",
        object_class="1",
        program_activity_code="123",
        program_activity_name="abc",
        program_activity_reporting_key="",
        by_direct_reimbursable_fun="r",
        disaster_emergency_fund_code="n",
        prior_year_adjustment="a",
    ...
    op9 = ObjectClassProgramActivityFactory(
        display_tas="abcde",
        object_class="1",
        program_activity_code="123",
        program_activity_name="abc",
