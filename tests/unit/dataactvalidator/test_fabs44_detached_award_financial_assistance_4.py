...
def test_success(database):
    ...
    det_award_1 = DetachedAwardFinancialAssistanceFactory(legal_entity_congressional=None,
                                                          record_type=1)

    det_award_2 = DetachedAwardFinancialAssistanceFactory(legal_entity_congressional="",
                                                          record_type=1)

    det_award_3 = DetachedAwardFinancialAssistanceFactory(legal_entity_congressional="01",
                                                          record_type=2)
...
def test_failure(database):
    ...
    det_award_1 = DetachedAwardFinancialAssistanceFactory(legal_entity_congressional="01",
                                                          record_type=1)
