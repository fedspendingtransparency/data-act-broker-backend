...
def test_success(database):
    ...
    af4 = AwardFinancialFactory(account_num=tas.account_num, program_activity_reporting_key='', object_class='9',
                                disaster_emergency_fund_code='s', prior_year_adjustment='')
    af5 = AwardFinancialFactory(account_num=tas.account_num, program_activity_reporting_key=None, object_class='9',
                                disaster_emergency_fund_code='s', prior_year_adjustment='')
...
def test_failure(database):
    ...
    af1 = AwardFinancialFactory(account_num=tas3.account_num, program_activity_reporting_key='1', object_class='1',
                                disaster_emergency_fund_code='s', prior_year_adjustment='')
    # Different PARK
    af2 = AwardFinancialFactory(account_num=tas1.account_num, program_activity_reporting_key='9', object_class='1',
                                disaster_emergency_fund_code='s', prior_year_adjustment=None)
