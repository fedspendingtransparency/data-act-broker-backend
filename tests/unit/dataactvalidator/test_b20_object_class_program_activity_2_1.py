...
def test_success(database):
    ...
    af4 = AwardFinancialFactory(account_num=tas.account_num, pa_reporting_key='1', object_class='9',
                                disaster_emergency_fund_code='s', prior_year_adjustment=None)
    # Ignored because PARK is NULL
    af5 = AwardFinancialFactory(account_num=tas.account_num, pa_reporting_key='', object_class='9',
                                disaster_emergency_fund_code='s', prior_year_adjustment='x')
    af6 = AwardFinancialFactory(account_num=tas.account_num, pa_reporting_key=None, object_class='9',
                                disaster_emergency_fund_code='s', prior_year_adjustment='x')
...
def test_failure(database):
    ...
    op2 = ObjectClassProgramActivityFactory(account_num=tas2.account_num, pa_reporting_key='1', object_class='2',
                                            disaster_emergency_fund_code='s', prior_year_adjustment='X')
    # Ignored because PYA is not X
    op3 = ObjectClassProgramActivityFactory(account_num=tas2.account_num, pa_reporting_key='5', object_class='0',
                                            disaster_emergency_fund_code='s', prior_year_adjustment='b')
    ...
    # Different PARK
    af2 = AwardFinancialFactory(account_num=tas1.account_num, pa_reporting_key='5', object_class='1',
                                disaster_emergency_fund_code='s', prior_year_adjustment='x')
    ...
    af6 = AwardFinancialFactory(account_num=tas2.account_num, pa_reporting_key='5', object_class='0',
                                disaster_emergency_fund_code='s', prior_year_adjustment='x')
