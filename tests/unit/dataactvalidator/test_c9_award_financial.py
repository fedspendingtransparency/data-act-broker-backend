...
def test_column_headers(database):
    expected_subset = {
        ...
        "source_value_fain",
        "source_value_uri",
        "source_value_federal_action_obligation",
        "difference",
        "uniqueid_FAIN",
        "uniqueid_URI",
    }
...
def test_equal_fain(database):
    ...
    afa = AwardFinancialAssistanceFactory(
        tas=tas, fain="aBc", uri=None, federal_action_obligation=1, original_loan_subsidy_cost="1", record_type="2"
    )
    af = AwardFinancialFactory(
        tas=tas, submisson_id=afa.submission_id, fain=afa.fain.lower(), uri=None, transaction_obligated_amou=1
    )
...
def test_equal_uri(database):
    ...
    tas = _TAS
    afa = AwardFinancialAssistanceFactory(
        tas=tas, fain=None, uri="xYz", federal_action_obligation=1, original_loan_subsidy_cost="1", record_type="1"
    )
    af = AwardFinancialFactory(
        tas=tas, submisson_id=afa.submission_id, fain=None, uri=afa.uri.lower(), transaction_obligated_amou=0
    )
...
def test_null_uri_fain(database):
    ...
    af = AwardFinancialFactory(
        tas=tas, submisson_id=afa.submission_id, fain="abc", uri="def", transaction_obligated_amou=1
    )
...
def test_both_fain_and_url_supplied(database):
    ...
    tas = _TAS
    afa_1 = AwardFinancialAssistanceFactory(
        tas=tas, fain="aBc", uri="xYz", federal_action_obligation=1, original_loan_subsidy_cost="1", record_type="2"
    )
    afa_2 = AwardFinancialAssistanceFactory(
        tas=tas, fain="dEf", uri="gHi", federal_action_obligation=1, original_loan_subsidy_cost="1", record_type="1"
    )
    af_1 = AwardFinancialFactory(
        tas=tas, submisson_id=afa_1.submission_id, fain=afa_1.fain.lower(), uri=None, transaction_obligated_amou=1
    )
    af_2 = AwardFinancialFactory(
        tas=tas, submisson_id=afa_2.submission_id, fain=None, uri=afa_2.uri.lower(), transaction_obligated_amou=0
    )
...
def test_unequal_fain(database):
    ...
    tas = _TAS
    afa = AwardFinancialAssistanceFactory(
        tas=tas, fain="abc", uri=None, federal_action_obligation=1, original_loan_subsidy_cost="1", record_type="3"
    )
    af = AwardFinancialFactory(
        tas=tas, submisson_id=afa.submission_id, fain="xyz", uri=None, transaction_obligated_amou=1
    )
...
def test_unequal_uri(database):
    ...
    tas = _TAS
    afa = AwardFinancialAssistanceFactory(
        tas=tas, fain=None, uri="abc", federal_action_obligation=1, original_loan_subsidy_cost="1", record_type="1"
    )
    af = AwardFinancialFactory(
        tas=tas, submisson_id=afa.submission_id, fain=None, uri="xyz", transaction_obligated_amou=1
    )
...
def test_unequal_fain_null(database):
    ...
    af = AwardFinancialFactory(
        tas=tas, submisson_id=afa.submission_id, fain=None, uri=None, transaction_obligated_amou=1
    )
...
def test_unequal_fain_aggregate(database):
    ...
    af = AwardFinancialFactory(
        tas=tas, submisson_id=afa.submission_id, fain="abc", uri="abc", transaction_obligated_amou=1
    )
...
def test_unequal_uri_non_aggregate(database):
    ...
    tas = _TAS
    afa = AwardFinancialAssistanceFactory(
        tas=tas, fain="abc", uri="xyz", federal_action_obligation=1, original_loan_subsidy_cost="1", record_type="1"
    )
    af = AwardFinancialFactory(
        tas=tas, submisson_id=afa.submission_id, fain="xyz", uri="xyz", transaction_obligated_amou=1
    )
...
def test_unequal_uri_null(database):
    ...
    tas = _TAS
    afa = AwardFinancialAssistanceFactory(
        tas=tas, fain=None, uri=None, federal_action_obligation=1, original_loan_subsidy_cost="1", record_type="1"
    )
    af = AwardFinancialFactory(
        tas=tas, submisson_id=afa.submission_id, fain=None, uri="abc", transaction_obligated_amou=1
    )
...
def test_zero_federal_action_obligation_and_original_loan_subsidy_cost(database):
    ...
    tas = _TAS
    afa = AwardFinancialAssistanceFactory(
        tas=tas, fain="abc", uri=None, federal_action_obligation=0, original_loan_subsidy_cost="0", record_type="3"
    )
    af = AwardFinancialFactory(
        tas=tas, submisson_id=afa.submission_id, fain=None, uri=None, transaction_obligated_amou=1
    )
...
def test_null_toa(database):
    ...
    af = AwardFinancialFactory(
        tas=tas, submisson_id=afa.submission_id, fain=afa.fain.lower(), uri=None, transaction_obligated_amou=None
    )
