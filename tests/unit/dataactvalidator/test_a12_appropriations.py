...
def test_success(database):
    ...
    assert run_sql_rule(_FILE, database.stagingDb, submission_id, sf_1, sf_2, sf_3, ap) == 0
...
def test_failure(database):
    ...
    assert run_sql_rule(_FILE, database.stagingDb, submission_id, sf_1, sf_2, sf_3, ap) == 1
