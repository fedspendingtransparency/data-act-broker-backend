...
def test_success_null(database):
    ...
    pa = ProgramActivityFactory(
        fiscal_year_period="FY17P12", agency_id="test", allocation_transfer_id="test", account_number="test"
    )
...
def test_success_fiscal_year_period(database):
    """Testing valid name for program_activity that matches with fiscal_year_period"""
...
def test_failure_fiscal_year_period(database):
    ...
    pa_1 = ProgramActivityFactory(
        fiscal_year_period="FPY",
        agency_id="test",
        allocation_transfer_id="test",
        account_number="test",
        program_activity_name="test",
...
def test_success_null_program_activity(database):
    ...
    pa = ProgramActivityFactory(
        fiscal_year_period="FYP", agency_id="test", allocation_transfer_id="test", account_number="test"
    )
