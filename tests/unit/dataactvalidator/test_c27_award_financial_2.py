...
def test_column_headers(database):
    expected_subset = {'row_number', 'tas', 'disaster_emergency_fund_code', 'program_activity_reporting_key',
                       'object_class', 'by_direct_reimbursable_fun', 'fain', 'uri', 'piid', 'parent_award_id',
                       'prior_year_adjustment', 'gross_outlay_amount_by_awa_cpe', 'uniqueid_TAS',
                       'uniqueid_DisasterEmergencyFundCode', 'uniqueid_ProgramActivityReportingKey',
                       'uniqueid_ObjectClass', 'uniqueid_PriorYearAdjustment',
...
def test_success(database):
    ...
    paf_fain = PublishedAwardFinancialFactory(submission_id=sub_1.submission_id, tas='test_tas', fain='aBcD', uri=None,
                                              ...
                                              program_activity_reporting_key='a', object_class=None,
    ...
    paf_tas = PublishedAwardFinancialFactory(submission_id=sub_1.submission_id, tas='different_tas', fain='hiJK',
                                             ...
                                             disaster_emergency_fund_code='n', program_activity_reporting_key='a',
    ...
    paf_all_9 = PublishedAwardFinancialFactory(submission_id=sub_1.submission_id, tas='test_tas', fain='aBcD',
                                               ...
                                               disaster_emergency_fund_code='9', program_activity_reporting_key='a',
                                               object_class=None, by_direct_reimbursable_fun=None,
                                               gross_outlay_amount_by_awa_cpe=5, prior_year_adjustment='X')
    paf_park = PublishedAwardFinancialFactory(submission_id=sub_1.submission_id, tas='test_tas', fain='hiJK',
                                              uri=None, piid=None, parent_award_id=None,
                                              disaster_emergency_fund_code='n', program_activity_reporting_key='c',
                                              object_class=None, by_direct_reimbursable_fun=None,
                                              gross_outlay_amount_by_awa_cpe=5, prior_year_adjustment='X')
    paf_obj = PublishedAwardFinancialFactory(submission_id=sub_1.submission_id, tas='test_tas', fain='hiJK',
                                             uri=None, piid=None, parent_award_id=None,
                                             disaster_emergency_fund_code='n', program_activity_reporting_key='a',
                                             object_class='c', by_direct_reimbursable_fun=None,
                                             gross_outlay_amount_by_awa_cpe=5, prior_year_adjustment='X')
    paf_dr = PublishedAwardFinancialFactory(submission_id=sub_1.submission_id, tas='test_tas', fain='hiJK',
                                            uri=None, piid=None, parent_award_id=None,
                                            disaster_emergency_fund_code='n', program_activity_reporting_key='a',
                                            object_class=None, by_direct_reimbursable_fun='r',
                                            gross_outlay_amount_by_awa_cpe=5, prior_year_adjustment='X')
    database.session.add_all([sub_1, paf_fain, paf_uri, paf_piid, paf_paid, paf_zero, paf_null, paf_tas, paf_all_9,
                              paf_park, paf_obj, paf_dr])
    ...
    af_9_match = AwardFinancialFactory(submission_id=sub_q.submission_id, tas='test_tas', fain='aBcD', uri='eFgH',
                                       ...
                                       by_direct_reimbursable_fun=None, gross_outlay_amount_by_awa_cpe=5,
                                       prior_year_adjustment='X')
    af_park = AwardFinancialFactory(submission_id=sub_q.submission_id, tas='test_tas', fain='hiJK',
                                    uri=None, piid=None, parent_award_id=None,
                                    disaster_emergency_fund_code='n', program_activity_reporting_key='c',
                                    object_class=None, by_direct_reimbursable_fun=None,
                                    gross_outlay_amount_by_awa_cpe=1, prior_year_adjustment='X')
    af_obj = AwardFinancialFactory(submission_id=sub_q.submission_id, tas='test_tas', fain='hiJK',
                                   uri=None, piid=None, parent_award_id=None,
                                   disaster_emergency_fund_code='n', program_activity_reporting_key='a',
                                   object_class='c', by_direct_reimbursable_fun=None, gross_outlay_amount_by_awa_cpe=3,
                                   prior_year_adjustment='X')
    af_dr = AwardFinancialFactory(submission_id=sub_q.submission_id, tas='test_tas', fain='hiJK',
                                  uri=None, piid=None, parent_award_id=None,
                                  disaster_emergency_fund_code='n', program_activity_reporting_key='a',
                                  object_class=None, by_direct_reimbursable_fun='r', gross_outlay_amount_by_awa_cpe=4,
                                  prior_year_adjustment='X')
    ...
    errors = number_of_errors(_FILE, database, models=[af_fain, af_uri, af_piid, af_paid, af_zero, af_null, af_tas,
                                                       af_9_match, af_park, af_obj, af_dr, af_bonus],
                              submission=sub_q)
    assert errors == 0
    ...
    af_9_match = AwardFinancialFactory(submission_id=sub_p.submission_id, tas='test_tas', fain='aBcD', uri='eFgH',
                                       ...
                                       by_direct_reimbursable_fun=None, gross_outlay_amount_by_awa_cpe=5,
                                       prior_year_adjustment='X')
    af_park = AwardFinancialFactory(submission_id=sub_p.submission_id, tas='test_tas', fain='hiJK',
                                    uri=None, piid=None, parent_award_id=None, disaster_emergency_fund_code='n',
                                    program_activity_reporting_key='c', object_class=None,
    ...
    af_obj = AwardFinancialFactory(submission_id=sub_p.submission_id, tas='test_tas', fain='hiJK',
                                   uri=None, piid=None, parent_award_id=None, disaster_emergency_fund_code='n',
                                   program_activity_reporting_key='a', object_class='c',
                                   by_direct_reimbursable_fun=None, gross_outlay_amount_by_awa_cpe=3,
                                   prior_year_adjustment='X')
    af_dr = AwardFinancialFactory(submission_id=sub_p.submission_id, tas='test_tas', fain='hiJK',
                                  uri=None, piid=None, parent_award_id=None, disaster_emergency_fund_code='n',
                                  program_activity_reporting_key='a', object_class=None, by_direct_reimbursable_fun='r',
                                  gross_outlay_amount_by_awa_cpe=4, prior_year_adjustment='X')
    # Additional line doesn't mess anything up
    ...
    af_9_match = AwardFinancialFactory(submission_id=sub_4.submission_id, tas='test_tas', fain='aBcD', uri='eFgH',
                                       ...
                                       by_direct_reimbursable_fun=None, gross_outlay_amount_by_awa_cpe=5,
                                       prior_year_adjustment='X')
    af_park = AwardFinancialFactory(submission_id=sub_4.submission_id, tas='test_tas', fain='hiJK',
                                    uri=None, piid=None, parent_award_id=None, disaster_emergency_fund_code='n',
                                    program_activity_reporting_key='c', object_class=None,
                                    by_direct_reimbursable_fun=None, gross_outlay_amount_by_awa_cpe=1,
                                    prior_year_adjustment='X')
    ...
    errors = number_of_errors(_FILE, database, models=[af_fain, af_uri, af_piid, af_paid, af_tas, af_park, af_obj,
                                                       af_dr, af_9_match],
                              submission=sub_4)
    assert errors == 0
    ...
    paf_park_null = PublishedAwardFinancialFactory(submission_id=sub_1.submission_id, tas='test_tas', fain='aBcD',
                                                   uri=None, piid=None, parent_award_id=None,
                                                   disaster_emergency_fund_code='N', program_activity_reporting_key='',
                                                   object_class=None, by_direct_reimbursable_fun=None,
                                                   gross_outlay_amount_by_awa_cpe=5, prior_year_adjustment='X')
    ...
    paf_pya = PublishedAwardFinancialFactory(submission_id=sub_1.submission_id, tas='test_tas', fain='aBcD',
                                             ...
                                             object_class='b', by_direct_reimbursable_fun=None,
                                             gross_outlay_amount_by_awa_cpe=5, prior_year_adjustment='b')
...
def test_failure(database):
    ...
    paf_defc = PublishedAwardFinancialFactory(submission_id=sub_1.submission_id, tas='test_tas', fain='abcd', uri=None,
                                              ...
                                              disaster_emergency_fund_code='O', program_activity_reporting_key='a',
                                              object_class=None, by_direct_reimbursable_fun=None,
                                              gross_outlay_amount_by_awa_cpe=5, prior_year_adjustment='X')
    ...
    af_null_park = PublishedAwardFinancialFactory(submission_id=sub_3.submission_id, tas='test_tas', fain='abcd',
                                                  uri=None, piid=None, parent_award_id=None,
                                                  disaster_emergency_fund_code='N', program_activity_reporting_key=None,
                                                  object_class=None, by_direct_reimbursable_fun=None,
                                                  gross_outlay_amount_by_awa_cpe=5, prior_year_adjustment='X')
