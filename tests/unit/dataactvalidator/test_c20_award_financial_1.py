...
af_dict = dict(
    ...
    prior_year_adjustment="some-PYA",
...
def test_success(database):
    """
    Tests that each USSGL account balance or subtotal, when totaled by combination of TAS, object class code,
    direct/reimbursable flag, and PYA provided in File C, should be a subset of, or equal to, the same combinations
    in File B.
    """
    ...
    op5 = ObjectClassProgramActivityFactory(
        ...
        object_class=af_dict["object_class"],
        by_direct_reimbursable_fun=af_dict["by_direct_reimbursable_fun"],
        prior_year_adjustment="some-other-PYA",
        submission_id=af_dict["submission_id"],
    )

    errors = number_of_errors(_FILE, database, models=[af1, af2, op1, op2, op3, op4, op5])
    assert errors == 0


def test_success_null_pya(database):
    """
    Tests that despite it needing to fail, this doesn't have PYA in File C.
    This split version only fails if PYA is provided in File C.
    """
    af_dict_sans_pya = af_dict.copy()
    af_dict_sans_pya["prior_year_adjustment"] = ""
    af1 = AwardFinancialFactory(**af_dict_sans_pya)
    ...
    errors = number_of_errors(_FILE, database, models=[af1, op1, op2, op3, op4, op5])
    assert errors == 0
...
def test_failure(database):
    ...
    code, direct/reimbursable flag, and PYA provided in File C, should be a subset of, or equal to, the same
