...
def test_column_headers(database):
    expected_subset = {'row_number', 'borrowing_authority_amount_cpe', 'lines', 'amounts'}
...
def test_success(database):
    ...
    sf1 = SF133Factory(tas=tas, period=1, fiscal_year=2016, line=1340, amount=1)
    sf2 = SF133Factory(tas=tas, period=1, fiscal_year=2016, line=1440, amount=1)
