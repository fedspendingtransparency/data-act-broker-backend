...
def test_success(database):
    ...
    op1 = AwardFinancialFactory(
        disaster_emergency_fund_code="l", transaction_obligated_amou=None, gross_outlay_amount_by_awa_cpe=2
    )
    # 0 in either field is still populated
    op2 = AwardFinancialFactory(
        disaster_emergency_fund_code="m", transaction_obligated_amou=0, gross_outlay_amount_by_awa_cpe=None
    )
    op3 = AwardFinancialFactory(
        disaster_emergency_fund_code="m", transaction_obligated_amou=None, gross_outlay_amount_by_awa_cpe=0
    )
    # wrong DEFC
    op4 = AwardFinancialFactory(
        disaster_emergency_fund_code="z", transaction_obligated_amou=None, gross_outlay_amount_by_awa_cpe=None
    )
    # DEFC but not COVID
    op5 = AwardFinancialFactory(
        disaster_emergency_fund_code="a", transaction_obligated_amou=None, gross_outlay_amount_by_awa_cpe=None
    )
    # populated TOA
    op6 = AwardFinancialFactory(
        disaster_emergency_fund_code="n", transaction_obligated_amou=1, gross_outlay_amount_by_awa_cpe=None
    )
    ...
    sub = SubmissionFactory(
        submission_id=2, reporting_fiscal_period=9, reporting_fiscal_year=2022, cgac_code="TEST", frec_code=None
    )
    op1 = AwardFinancialFactory(
        disaster_emergency_fund_code="p",
...
def test_failure(database):
    ...
    """
    op1 = AwardFinancialFactory(
        disaster_emergency_fund_code="p", transaction_obligated_amou=None, gross_outlay_amount_by_awa_cpe=None
    )
    ...
    # Testing for a submission after 2022
    sub = SubmissionFactory(
        submission_id=4, reporting_fiscal_period=9, reporting_fiscal_year=2022, cgac_code="TEST", frec_code=None
    )
    op1 = AwardFinancialFactory(
        disaster_emergency_fund_code="t",
        transaction_obligated_amou=None,
