...
def test_success(database):
    ...
    """
    fabs_1 = FABSFactory(funding_opportunity_number="", assistance_type="F006", correction_delete_indicatr="C")
    fabs_2 = FABSFactory(funding_opportunity_number=None, assistance_type="F008", correction_delete_indicatr=None)

    # Ignored for other assistance types
    fabs_3 = FABSFactory(funding_opportunity_number="123", assistance_type="F001", correction_delete_indicatr="C")

    # Ignored for CorrectionDeleteIndicator of D
    fabs_4 = FABSFactory(funding_opportunity_number="123", assistance_type="F008", correction_delete_indicatr="d")
