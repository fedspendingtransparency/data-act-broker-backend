...
def test_success(database):
    ...
    paf_pac = PublishedAwardFinancialFactory(
        submission_id=sub_1.submission_id,
        tas="test_tas",
        fain="hiJK",
        uri=None,
    ...
    paf_pan = PublishedAwardFinancialFactory(
        submission_id=sub_1.submission_id,
        tas="test_tas",
        fain="hiJK",
        uri=None,
    ...
    errors = number_of_errors(
        _FILE,
        database,
        models=[af_fain, af_uri, af_piid, af_paid, af_tas, af_pac, af_pan, af_obj, af_dr, af_9_match],
        submission=sub_4,
    )
    assert errors == 0
    ...
    sub_pacpan_null_prev = SubmissionFactory(
        submission_id=6,
        cgac_code="test",
    ...
    paf_pacpan_null = PublishedAwardFinancialFactory(
        submission_id=sub_1.submission_id,
        tas="test_tas",
        fain="aBcD",
        uri=None,
    ...
    sub_pacpan_curr = SubmissionFactory(
        submission_id=7,
        reporting_fiscal_year=2018,
        reporting_fiscal_period=4,
        cgac_code="test",
...
def test_failure(database):
    ...
    af_null_pacpan = PublishedAwardFinancialFactory(
        submission_id=sub_3.submission_id,
        tas="test_tas",
        fain="abcd",
        uri=None,
