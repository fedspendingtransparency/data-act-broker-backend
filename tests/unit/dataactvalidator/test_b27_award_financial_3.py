...
def test_success(database):
    ...
    assert number_of_errors(_FILE, database, models=[af1, af2, af3, af4], submission=sub) == 0
...
def test_failure(database):
    ...
    assert number_of_errors(_FILE, database, models=[af1, af2, af3, af4, af5], submission=sub) == 5
