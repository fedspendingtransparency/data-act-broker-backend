...
def test_column_headers(database):
    expected_subset = {
        ...
        "expected_value_GTAS SF133 Line 2190",
        "difference",
    }
...
def test_success(database):
    ...
    ap = Appropriation(job_id=1, row_number=1, display_tas=tas, obligations_incurred_total_cpe=1)
    ...
    ap = Appropriation(job_id=1, row_number=1, display_tas=tas, obligations_incurred_total_cpe=5)
...
def test_failure(database):
    ...
    ap = Appropriation(job_id=1, row_number=1, display_tas=tas, obligations_incurred_total_cpe=0)
