...
def test_success(database):
    """ Test if LegalEntityCongressionalDistrict is provided with an ActionDate on or after 20230103, then the
    ...
    """
    zips_1 = ZipsFactory(zip5='12345', zip_last4='6789', congressional_district_no='01')
    zips_2 = ZipsFactory(zip5='12345', zip_last4='9876', congressional_district_no='02')

    fabs_1 = FABSFactory(legal_entity_zip5='12345', legal_entity_zip_last4='',
                         legal_entity_congressional='02', correction_delete_indicatr='', action_date='20230830')
    fabs_2 = FABSFactory(legal_entity_zip5='12345', legal_entity_zip_last4='6789',
                         legal_entity_congressional='01', correction_delete_indicatr='', action_date='20230830')
    # Test ignoring blank/empty string zips
    fabs_3 = FABSFactory(legal_entity_zip5=None, legal_entity_zip_last4='',
                         legal_entity_congressional='03', correction_delete_indicatr='', action_date='20230830')
    ...
    fabs_5 = FABSFactory(legal_entity_zip5='12345', legal_entity_zip_last4='',
                         legal_entity_congressional='90', correction_delete_indicatr='', action_date='20230830')
    # Ignore correction delete indicator of D
    fabs_6 = FABSFactory(legal_entity_zip5='12345', legal_entity_zip_last4='',
                         legal_entity_congressional='03', correction_delete_indicatr='d', action_date='20230830')
...
def test_failure(database):
    """ Test failure if LegalEntityCongressionalDistrict is provided with an ActionDate on or after 20230103, then the
        LegalEntityCongressionalDistrict should be associated with the provided LegalEntityZIP5 and LegalEntityZIPLast4
        according to the current USPS source data.
    """
    zips = ZipsFactory(zip5='12345', zip_last4='6789', congressional_district_no='01')
