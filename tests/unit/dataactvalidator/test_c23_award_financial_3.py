...
def test_success(database):
    ...
    af_1_row_2 = AwardFinancialFactory(
        transaction_obligated_amou=11, fain=fain_1.lower(), allocation_transfer_agency=None
    )
    # Ignored row because it has non-matching ATA/AID but the rest of the sum works
    af_1_row_3 = AwardFinancialFactory(
        transaction_obligated_amou=99, fain=fain_1, allocation_transfer_agency="good", agency_identifier="bad"
    )
    ...
    af_2_row_2 = AwardFinancialFactory(
        transaction_obligated_amou=99, fain=fain_2, allocation_transfer_agency="good", agency_identifier="good"
    )
    # Ignored row with non-matching ATA/AID
    af_3 = AwardFinancialFactory(
        transaction_obligated_amou=8888, fain=fain_3, allocation_transfer_agency="good", agency_identifier="bad"
    )
    ...
    afa_1_row_1 = AwardFinancialAssistanceFactory(
        fain=fain_1, federal_action_obligation=-1100, original_loan_subsidy_cost=None, record_type="2"
    )
    afa_1_row_2 = AwardFinancialAssistanceFactory(
        fain=fain_1.lower(), federal_action_obligation=-10, original_loan_subsidy_cost=None, record_type="3"
    )
    ...
    afa_1_row_5 = AwardFinancialAssistanceFactory(
        fain=fain_1, federal_action_obligation=-1100, original_loan_subsidy_cost=None, record_type="1"
    )
    # Fain 2 Test for non-ignored ATA
    afa_2 = AwardFinancialAssistanceFactory(
        fain=fain_2, federal_action_obligation=-9999, original_loan_subsidy_cost=None, record_type="2"
    )
...
def test_failure(database):
    ...
    af_1_row_1 = AwardFinancialFactory(transaction_obligated_amou=1100, fain=fain_1, allocation_transfer_agency=None)
    af_1_row_2 = AwardFinancialFactory(
        transaction_obligated_amou=9, fain=fain_1.lower(), allocation_transfer_agency=None
    )
    # Ignore row that would make it add up right if it was counted because of non-matching ATA/AID
    af_1_row_3 = AwardFinancialFactory(
        transaction_obligated_amou=1, fain=fain_1.lower(), allocation_transfer_agency="good", agency_identifier="bad"
    )
    ...
    af_3 = AwardFinancialFactory(
        transaction_obligated_amou=1111, fain=fain_3, allocation_transfer_agency="good", agency_identifier="good"
    )
    # Not ignored with TOA of 0
    af_4 = AwardFinancialFactory(
        transaction_obligated_amou=0, fain=fain_4, allocation_transfer_agency="good", agency_identifier="good"
    )
    ...
    afa_2_row_2 = AwardFinancialAssistanceFactory(
        fain=fain_2,
        federal_action_obligation=None,
        original_loan_subsidy_cost=-9999,
        assistance_type="07",
        record_type="3",
    )
    # This shouldn't be ignored
    afa_3 = AwardFinancialAssistanceFactory(
        fain=fain_3, federal_action_obligation=0, original_loan_subsidy_cost=None, record_type="2"
    )
    # Shouldn't be ignored with a TOA of 0
    afa_4 = AwardFinancialAssistanceFactory(
        fain=fain_4, federal_action_obligation=1, original_loan_subsidy_cost=None, record_type="2"
    )
