...
def test_success(database):
    ...
    wrong_type_afa_row = AwardFinancialAssistanceFactory(fain = fain, original_loan_subsidy_cost = -2222, assistance_type = '09')
...
def test_failure(database):
    ...
    other_fain_afa_row = AwardFinancialAssistanceFactory(fain = fain_two, federal_action_obligation = -1111)

    errors = number_of_errors(_FILE, database, models=[first_fain_row_one, first_fain_row_two, second_fain_row_one, first_afa_row, second_afa_row, other_fain_afa_row])
    assert errors == 2