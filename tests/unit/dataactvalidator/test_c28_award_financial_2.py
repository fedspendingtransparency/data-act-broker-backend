...
def test_success(database):
    """
    Tests the combination of TAS/object class/PARK/reimbursable flag/DEFC/Award ID/PYA in File C (award financial)
    ...
    assert number_of_errors(_FILE, database, models=[af1, af2, af3, af4, af5, af6, af7, af8, af9, af10, af11]) == 0


def test_ignore_toa(database):
    """
    Tests that all combinations of TAS/object class/PARK/reimbursable flag/DEFC/Award ID/PYA in File C (award
