...
def test_success(database):
    ...
    pub_fabs_1 = PublishedFABSFactory(
        afa_generated_unique="ama1asta1fain1uri2", correction_delete_indicatr=None, is_active=True
    )
    pub_fabs_2 = PublishedFABSFactory(
        afa_generated_unique="ama1asta2fain1uri1", correction_delete_indicatr=None, is_active=True
    )
    ...
    pub_fabs_4 = PublishedFABSFactory(
        afa_generated_unique="ama2asta1fain1uri1", correction_delete_indicatr=None, is_active=True
    )
    pub_fabs_5 = PublishedFABSFactory(
        afa_generated_unique="ama1asta1fain1uri1", correction_delete_indicatr=None, is_active=False
    )

    errors = number_of_errors(
        _FILE, database, models=[fabs_1, fabs_2, fabs_3, pub_fabs_1, pub_fabs_2, pub_fabs_3, pub_fabs_4, pub_fabs_5]
    )
    assert errors == 0
