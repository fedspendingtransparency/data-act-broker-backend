...
def test_success(database):
    ...
    fabs_2 = FABSFactory(
        legal_entity_country_code="UK", legal_entity_foreign_provi="", record_type=2, correction_delete_indicatr=None
    )
    fabs_3 = FABSFactory(
        legal_entity_country_code="UK", legal_entity_foreign_provi=None, record_type=1, correction_delete_indicatr="c"
    )
    fabs_4 = FABSFactory(
        legal_entity_country_code="USA", legal_entity_foreign_provi=None, record_type=3, correction_delete_indicatr="C"
    )
    fabs_5 = FABSFactory(
        legal_entity_country_code="USA", legal_entity_foreign_provi="", record_type=2, correction_delete_indicatr=""
    )
