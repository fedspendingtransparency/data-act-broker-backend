...
def test_column_headers(database):
    expected_subset = {'row_number', 'awarding_office_code', 'uniqueid_afa_generated_unique'}
...
def test_failure(database):
    ...
    pub_award_5 = PublishedAwardFinancialAssistanceFactory(awarding_office_code='abc', unique_award_key='zyxwv_1234',
