...
def test_success(database):
    ...
    ocpa = ObjectClassProgramActivityFactory(
        obligations_delivered_orde_fyb=value, ussgl490100_delivered_orde_fyb=value, prior_year_adjustment="X"
    )
    ocpa_null = ObjectClassProgramActivityFactory(
        obligations_delivered_orde_fyb=0, ussgl490100_delivered_orde_fyb=None, prior_year_adjustment="x"
    )
    # Different values, different PYA
    ocpa_pya = ObjectClassProgramActivityFactory(
        obligations_delivered_orde_fyb=0, ussgl490100_delivered_orde_fyb=1, prior_year_adjustment="A"
    )
