...
def test_success(database):
    ...
    fabs_4 = FABSFactory(funding_opportunity_number="", action_date="10/01/2025", award_recipient_basis_code='R02',
                         assistance_type="F001", correction_delete_indicatr=None)

    # Ignored for Action date of 10/01/2026 or later
    fabs_5 = FABSFactory(funding_opportunity_number=None, action_date="10/01/2026", award_recipient_basis_code=None,
                         assistance_type="F001", correction_delete_indicatr=None)

    # Ignored for CorrectionDeleteIndicator of D
    fabs_6 = FABSFactory(funding_opportunity_number=None, action_date="10/01/2025", award_recipient_basis_code='', assistance_type="F001", correction_delete_indicatr="d")
