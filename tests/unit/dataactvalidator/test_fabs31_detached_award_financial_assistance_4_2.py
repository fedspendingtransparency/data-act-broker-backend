...
def test_pubished_date_success(database):
    """ Test success for when provided, AwardeeOrRecipientUEI must be registered (not necessarily active) in SAM,
        unless the ActionDate is before October 1, 2010. For AssistanceType 06, 07, 08, 09, 10, or 11 with an
    ...
    duns = DUNS(uei='11111111111E')
    det_award_1 = DetachedAwardFinancialAssistanceFactory(uei=duns.uei, assistance_type='06', action_date='10/02/2010',
                                                          correction_delete_indicatr='',
                                                          unique_award_key='before_key')
    det_award_2 = DetachedAwardFinancialAssistanceFactory(uei=duns.uei.lower(), assistance_type='07',
                                                          action_date='10/02/2010',
                                                          correction_delete_indicatr='c',
                                                          unique_award_key='before_key')
    det_award_3 = DetachedAwardFinancialAssistanceFactory(uei=None, assistance_type='09', action_date='10/02/2010',
                                                          correction_delete_indicatr='c',
                                                          unique_award_key='before_key')
    # Before October 1, 2010
    det_award_4 = DetachedAwardFinancialAssistanceFactory(uei='12345', assistance_type='10', action_date='09/30/2010',
                                                          correction_delete_indicatr='C',
                                                          unique_award_key='before_key')
    # Ignore correction delete indicator of D
    det_award_5 = DetachedAwardFinancialAssistanceFactory(uei='12345', assistance_type='06', action_date='10/02/2010',
                                                          correction_delete_indicatr='d',
                                                          unique_award_key='before_key')
    # Ignore other assistance types
    det_award_6 = DetachedAwardFinancialAssistanceFactory(uei='12345', assistance_type='02', action_date='10/02/2010',
                                                          correction_delete_indicatr='c',
                                                          unique_award_key='before_key')
    ...
    det_award_8 = DetachedAwardFinancialAssistanceFactory(uei='12345', assistance_type='06', action_date='04/05/2022',
                                                          correction_delete_indicatr='',
                                                          unique_award_key='inactive_key')
    det_award_9 = DetachedAwardFinancialAssistanceFactory(uei='12345', assistance_type='06', action_date='04/05/2022',
                                                          correction_delete_indicatr='',
...
def test_pubished_date_failure(database):
    ...
    # new records that may or may not be related to older awards
    duns = DUNS(uei='11111111111E')
    det_award_1 = DetachedAwardFinancialAssistanceFactory(uei='12345', assistance_type='06', action_date='10/02/2010',
                                                          correction_delete_indicatr='',
                                                          unique_award_key='before_key')
    det_award_2 = DetachedAwardFinancialAssistanceFactory(uei='12345', assistance_type='06', action_date='10/03/2010',
                                                          correction_delete_indicatr='c',
                                                          unique_award_key='before_key')
    models += [duns, det_award_1, det_award_2]
