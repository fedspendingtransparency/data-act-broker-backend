...
def test_success(database):
    ...
    """
    fabs_1 = FABSFactory(funding_opportunity_number="1234", assistance_type="F002", correction_delete_indicatr="C")
    ...
    fabs_3 = FABSFactory(funding_opportunity_number="", assistance_type="F008", correction_delete_indicatr="C")

    # Ignored for CorrectionDeleteIndicator of D
    fabs_4 = FABSFactory(funding_opportunity_number=None, assistance_type="F001", correction_delete_indicatr="d")
...
def test_failure(database):
    ...
    (AssistanceType = F001 or F002).
    """
    fabs_1 = FABSFactory(funding_opportunity_number=None, assistance_type="F001", correction_delete_indicatr="C")
