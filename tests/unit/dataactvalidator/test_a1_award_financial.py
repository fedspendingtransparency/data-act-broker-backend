...
def test_success(database):
    ...
    approp = AwardFinancialFactory(allocation_transfer_agency = tas.allocation_transfer_agency,
    ...
    approp_null = AwardFinancialFactory(allocation_transfer_agency = None,
