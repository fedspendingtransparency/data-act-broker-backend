...
def test_pubished_date_success(database):
    ...
    det_award_1 = DetachedAwardFinancialAssistanceFactory(uei=duns.uei, action_type='b', action_date='06/22/2017',
...
def test_pubished_date_failure(database):
    ...
    errors = number_of_errors(_FILE, database, models=[duns, det_award_1, det_award_2, det_award_3])
    assert errors == 3
