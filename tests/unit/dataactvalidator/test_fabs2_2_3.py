...
def test_failure(database):
    ...
    fabs_1 = FABSFactory(afa_generated_unique="ama1asta1fain2uri1", correction_delete_indicatr="D")
    # Test that capitalization differences don't affect the error
    fabs_2 = FABSFactory(afa_generated_unique="amA1astA1fain2uRi1", correction_delete_indicatr="D")
