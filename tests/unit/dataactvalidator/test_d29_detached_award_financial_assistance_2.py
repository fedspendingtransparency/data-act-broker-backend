...
_FILE = 'd29_detached_award_financial_assistance_2'
...
def test_failure(database):
    ...
    det_award = DetachedAwardFinancialAssistanceFactory(assistance_type="03", original_loan_subsidy_cost=0)
    det_award_2 = DetachedAwardFinancialAssistanceFactory(assistance_type="05", original_loan_subsidy_cost=20)
