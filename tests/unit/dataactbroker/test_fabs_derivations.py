...
def initialize_db_values(db):
    ...
    zip_code_historical_1 = ZipsHistoricalFactory(zip5='11111', zip_last4='1111', state_abbreviation='NY',
    ...
    # Cities
    zip_city = ZipCityFactory(zip_code=zip_code_1.zip5, state_code=zip_code_1.state_abbreviation,
                              preferred_city_name='Test City')
    zip_city_2 = ZipCityFactory(zip_code=zip_code_3.zip5, state_code=zip_code_3.state_abbreviation,
                                preferred_city_name='Test City 2')
    zip_city_3 = ZipCityFactory(zip_code=zip_code_4.zip5, state_code=zip_code_4.state_abbreviation,
                                preferred_city_name='Test City 3')
    zip_city_4 = ZipCityFactory(zip_code=zip_code_historical_1.zip5,
...
def test_legal_entity_derivations(database):
    ...
    submission_id = initialize_test_row(database, le_zip5='11111', le_zip4='1111', submission_id=2,
                                        action_date='2022/01/01')
    fabs_derivations(database.session, submission_id)
    database.session.commit()
    fabs_obj = get_derived_fabs(database, submission_id)
