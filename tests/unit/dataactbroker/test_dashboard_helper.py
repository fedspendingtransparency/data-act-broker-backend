...
def test_generate_file_type():
    ...
    # Cross
    assert (
        dashboard_helper.generate_file_type(FILE_TYPE_DICT_LETTER_ID["A"], FILE_TYPE_DICT_LETTER_ID["B"]) == "cross-AB"
    )
    assert (
        dashboard_helper.generate_file_type(FILE_TYPE_DICT_LETTER_ID["B"], FILE_TYPE_DICT_LETTER_ID["C"]) == "cross-BC"
    )
    assert (
        dashboard_helper.generate_file_type(FILE_TYPE_DICT_LETTER_ID["C"], FILE_TYPE_DICT_LETTER_ID["D1"])
        == "cross-CD1"
    )
    assert (
        dashboard_helper.generate_file_type(FILE_TYPE_DICT_LETTER_ID["C"], FILE_TYPE_DICT_LETTER_ID["D2"])
        == "cross-CD2"
    )
    # Bad
