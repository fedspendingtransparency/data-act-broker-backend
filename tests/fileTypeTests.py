...
class FileTypeTests(BaseTestValidator):
    ...
    def test_approp_mixed(self):
        ...
        self.passed = self.run_test(
            jobId, 200, "finished", 7052, 4, "complete", 50, True)
    ...
    def test_program_mixed(self):
        ...
        self.passed = self.run_test(
            jobId, 200, "finished", 21456, 4, "complete", 123, True)
    ...
    def test_award_fin_mixed(self):
        ...
        self.passed = self.run_test(
            jobId, 200, "finished", 17246, 6, "complete", 87, True)
    ...
    def test_award_mixed(self):
        ...
        self.passed = self.run_test(
            jobId, 200, "finished", 3341, 5, "complete", 40, True)
