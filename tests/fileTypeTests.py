...
class FileTypeTests(BaseTestValidator):
    ...
    def test_award_fin_mixed(self):
        ...
        self.passed = self.run_test(
        jobId, 200, "finished", 8000, 5, "complete", 48, True, 29, 9127)
    ...
    def test_award_fin_mixed_shortcols(self):
        ...
        self.passed = self.run_test(
            jobId, 200, "finished", 8000, 5, "complete", 48, True, 31, 11069)
    ...
    def test_award_mixed(self):
        ...
        self.passed = self.run_test(
            jobId, 200, "finished", 1139, 5, "complete", 17, True, 24, 2085)
