...
class SettingsTests(BaseTestAPI):
    ...
    def test_get_rule_settings_fail(self):
        ...
        response = self.app.get(
            "/v1/rule_settings/", rule_settings_params, expect_errors=True, headers={"x-session-id": self.session_id}
        )
    ...
    def test_get_rule_settings_permissions_error(self):
        ...
        rule_settings_params = {"agency_code": "097", "file": "B"}
        response = self.app.get(
            "/v1/rule_settings/", rule_settings_params, headers={"x-session-id": self.session_id}, expect_errors=True
        )
    ...
    def test_save_rule_settings(self):
        ...
        response = self.app.post_json(
            "/v1/save_rule_settings/", rule_settings_params, headers={"x-session-id": self.session_id}
        )
