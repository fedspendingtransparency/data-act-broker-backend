...
class GenerationTests(BaseTestAPI):
    ...
    def test_bad_file_type_check_generation_status(self):
        ...
        response = self.app.get(
            "/v1/check_generation_status/", post_json, headers={"x-session-id": self.session_id}, expect_errors=True
        )
    ...
    def test_file_generation_d1(self):
        ...
        post_json = {
            "submission_id": self.generation_submission_id,
            "file_type": "D1",
            "start": "01/02/2016",
            "end": "02/03/2016",
        }
    ...
    def test_generate_file_invalid_file_type(self):
        ...
        response = self.app.post_json(
            "/v1/generate_file/", post_json, headers={"x-session-id": self.session_id}, expect_errors=True
        )
    ...
    def test_generate_file_fabs(self):
        ...
        post_json = {
            "submission_id": self.test_fabs_submission_id,
            "file_type": "D1",
            "start": "01/02/2016",
            "end": "02/03/2016",
        }
    ...
    def test_detached_d_file_generation(self):
        ...
        response = self.app.post_json(
            "/v1/generate_detached_file/", post_json, headers={"x-session-id": self.session_id}
        )
    ...
    def test_detached_d_file_generation_quarter_fail(self):
        ...
        response = self.app.post_json(
            "/v1/generate_detached_file/", post_json, headers={"x-session-id": self.session_id}, expect_errors=True
        )
