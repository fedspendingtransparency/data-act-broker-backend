...
class DashboardTests(BaseTestAPI):
    ...
    def setUpClass(cls):
        ...
        with create_app().app_context():
            ...
            cls.quarter_sub = insert_submission(
                cls.session,
    ...
    def test_get_rule_labels(self):
        ...
        response = self.app.post_json(
            "/v1/get_rule_labels/", rule_label_json, headers={"x-session-id": self.session_id}
        )
    ...
    def test_get_rule_labels_fail(self):
        ...
        response = self.app.post_json(
            "/v1/get_rule_labels/", params, expect_errors=True, headers={"x-session-id": self.session_id}
        )
    ...
    def test_post_dabs_graphs(self):
        ...
        response = self.app.post_json(
            "/v1/historic_dabs_graphs/", dabs_summary_json, headers={"x-session-id": self.session_id}
        )
        self.assertEqual(response.status_code, 200)
        self.assertEqual(
    ...
    def test_post_dabs_graphs_fail(self):
        ...
        self.assertEqual(response.status_code, 400)
        self.assertEqual(
            response.json["message"], "Periods must be a list of integers, each ranging 2-12," " or an empty list."
        )
        ...
        self.assertEqual(
            ...
            "Fiscal Years must be a list of integers, each ranging from 2017"
        ...
        self.assertEqual(
            response.json["message"],
            "Files must be a list of one or more of the following,"
    ...
    def test_historic_dabs_table(self):
        ...
        response = self.app.post_json(
            "/v1/historic_dabs_table/", dabs_summary_json, headers={"x-session-id": self.session_id}
        )
        self.assertEqual(response.status_code, 200)
    ...
    def test_historic_dabs_table_fail(self):
        ...
        dabs_graphs_json = {"filters": {}}
        response = self.app.post_json(
            "/v1/historic_dabs_table/", dabs_graphs_json, expect_errors=True, headers={"x-session-id": self.session_id}
        )
        self.assertEqual(response.status_code, 400)
        self.assertEqual(
            response.json["message"], "The following filters were not provided: periods, fys, agencies," " files, rules"
    ...
    def test_active_submission_overview_fail(self):
        ...
        response = self.app.get(
            "/v1/active_submission_overview/", params, expect_errors=True, headers={"x-session-id": self.session_id}
        )
        self.assertEqual(response.status_code, 400)
    ...
    def test_get_impact_counts_fail(self):
        ...
        params = {"submission_id": -1, "file": "A"}
        response = self.app.get(
            "/v1/get_impact_counts/", params, expect_errors=True, headers={"x-session-id": self.session_id}
        )
        self.assertEqual(response.status_code, 400)
        self.assertEqual(response.json["message"], "No such submission")
    ...
    def test_get_significance_counts_fail(self):
        ...
        params = {"submission_id": -1, "file": "A"}
        response = self.app.get(
            "/v1/get_significance_counts/", params, expect_errors=True, headers={"x-session-id": self.session_id}
        )
        self.assertEqual(response.status_code, 400)
        self.assertEqual(response.json["message"], "No such submission")
