...
APPROP_FILE_T = ("appropriations", "appropriations.csv", open("tests/integration/data/appropValid.csv", "rb").read())
PA_FILE_T = (
    "program_activity",
...
class FileTests(BaseTestAPI):
    ...
    def setUpClass(cls):
        ...
        with create_app().app_context():
            ...
            cls.error_report_submission_id = insert_submission(
            ...
            cls.test_metrics_submission_id = insert_submission(
            ...
            cls.row_error_submission_id = insert_submission(
                sess,
            ...
            cls.test_published_submission_id = insert_submission(
                sess,
                cls.submission_user_id,
                cgac_code="SYS",
                start_date="07/2015",
            ...
            cls.test_updated_submission_id = insert_submission(
                sess,
                cls.submission_user_id,
                cgac_code="SYS",
                start_date="07/2016",
            ...
            cls.test_reverting_submission_id = insert_submission(
                sess,
                cls.submission_user_id,
                cgac_code="SYS",
                start_date="07/2020",
            ...
            cls.test_unpublished_submission_id = insert_submission(
                sess,
                cls.submission_user_id,
                cgac_code="SYS",
                start_date="04/2015",
            ...
            cls.test_post_fy22_submission_id = insert_submission(
                sess,
                cls.submission_user_id,
                cgac_code="SYS",
                start_date="04/2022",
            ...
            cls.test_revalidate_submission_id = insert_submission(
                sess,
                cls.submission_user_id,
                cgac_code="SYS",
                start_date="10/2015",
            ...
            cls.test_monthly_submission_id = insert_submission(
                sess,
                cls.submission_user_id,
                cgac_code="SYS",
                start_date="04/2022",
            ...
            cls.dup_test_monthly_submission_id = insert_submission(
                sess,
                cls.submission_user_id,
                cgac_code="SYS",
                start_date="04/2022",
            ...
            cls.test_monthly_pub_submission_id = insert_submission(
                sess,
                cls.submission_user_id,
                cgac_code="SYS",
                start_date="09/2014",
            ...
            cls.test_monthly_cert_submission_id = insert_submission(
                sess,
                cls.submission_user_id,
                cgac_code="SYS",
                start_date="10/2014",
            ...
            cls.test_test_submission_id = insert_submission(
                sess,
                cls.submission_user_id,
                cgac_code="SYS",
                start_date="10/2015",
            ...
            cls.test_fabs_submission_id = insert_submission(
                sess,
                cls.submission_user_id,
                cgac_code="SYS",
                start_date="10/2015",
            ...
            cls.test_other_user_submission_id = insert_submission(
                sess,
                cls.other_user_id,
                cgac_code="NOT",
                start_date="10/2015",
        ...
        if not self.files_submitted:
            if CONFIG_BROKER["use_aws"]:
                self.filenames = {
                    ...
                    "reporting_period_end_date": "03/2001",
                    "is_quarter": True,
                }
            else:
            ...
            self.submit_files_response = self.app.post(
    ...
    def test_update_submission(self):
        ...
        file_path = (
            "updated.csv" if CONFIG_BROKER["use_aws"] else os.path.join(CONFIG_BROKER["broker_files"], "updated.csv")
        )
        update_json = {
            "existing_submission_id": self.update_submission_id,
        ...
        with create_app().app_context():
            sess = GlobalDB.db().session
            update_submission = (
                sess.query(Submission).filter(Submission.submission_id == self.update_submission_id).one()
            )
            update_submission.publish_status_id = PUBLISH_STATUS_DICT["published"]
            sess.commit()
            update_response = self.app.post(
                "/v1/upload_dabs_files/",
                update_json,
                upload_files=[
                    ("award_financial", file_path, open("tests/integration/data/awardFinancialValid.csv", "rb").read())
                ],
                headers={"x-session-id": self.session_id},
            )
    ...
    def test_upload_dabs_files_reverting_status_submission(self):
        ...
        self.assertEqual(update_response.status_code, 400)
        self.assertEqual(
            update_response.json["message"], "Existing submission must not be publishing, certifying, or" " reverting"
        )
    ...
    def test_submit_file_old_no_params(self):
        ...
        response = self.app.post(
            "/v1/upload_dabs_files/", update_json, headers={"x-session-id": self.session_id}, expect_errors=True
        )
        self.assertEqual(response.status_code, 400)
    ...
    def test_submit_file_missing_parameters(self):
        ...
        self.assertEqual(response.status_code, 400)
        self.assertEqual(
            response.json["message"], "Missing required parameter: cgac_code, frec_code, or existing_submission_id"
        )
    ...
    def test_submit_file_monthly_submission_wrong_dates(self):
        ...
        self.assertEqual(
            ...
            "A monthly submission must be exactly one month with the exception"
    ...
    def test_both_cgac_and_frec(self):
        ...
        self.assertEqual(response.status_code, 400)
        self.assertEqual(
            response.json["message"], "New DABS submissions must have either a CGAC or a FREC code but not" " both"
        )
    ...
    def test_revalidation_threshold_no_login(self):
        ...
        response = self.app.get(
            "/v1/revalidation_threshold/", None, expect_errors=True, headers={"x-session-id": self.session_id}
        )
    ...
    def test_submission_metadata_no_login(self):
        ...
        response = self.app.get(
            "/v1/submission_metadata/", params, expect_errors=True, headers={"x-session-id": self.session_id}
        )
        self.assertEqual(response.status_code, 401)
    ...
    def test_submission_data_no_login(self):
        ...
        params = {"submission_id": self.status_check_submission_id}
        response = self.app.get(
            "/v1/submission_data/", params, expect_errors=True, headers={"x-session-id": self.session_id}
        )
        self.assertEqual(response.status_code, 401)
    ...
    def test_check_status_no_login(self):
        ...
        params = {"submission_id": self.status_check_submission_id}
        response = self.app.get(
            "/v1/check_status/", params, expect_errors=True, headers={"x-session-id": self.session_id}
        )
        # Assert 401 status
        self.assertEqual(response.status_code, 401)
    ...
    def test_delete_submission(self):
        ...
        response = self.app.get(
            "/v1/check_status/", post_json, headers={"x-session-id": self.session_id}, expect_errors=True
        )
        ...
        job_deps = (
            ...
            .filter(or_(JobDependency.job_id.in_(job_ids), JobDependency.prerequisite_id.in_(job_ids)))
            .all()
        )
        ...
        response = self.app.post_json(
            "/v1/delete_submission/", post_json, headers={"x-session-id": self.session_id}, expect_errors=True
        )
    ...
    def test_published_submission_ids_empty(self):
        ...
        response = self.app.get(
            "/v1/published_submissions/", params, headers={"x-session-id": self.session_id}, expect_errors=False
        )
    ...
    def test_publish_and_certify_dabs_submission(self):
        ...
        response = self.app.post_json(
            "/v1/publish_and_certify_dabs_submission/",
            post_json,
            headers={"x-session-id": self.session_id},
            expect_errors=True,
        )
        ...
        insert_job(
            ...
            self.test_unpublished_submission_id,
            num_valid_rows=0,
        )
        ...
        submission_window = SubmissionWindowSchedule(
            year=test_sub.reporting_fiscal_year,
            period=test_sub.reporting_fiscal_period,
            period_start=datetime.now() - timedelta(days=1),
        )
        submission_window_2 = SubmissionWindowSchedule(
            year=test_sub_2.reporting_fiscal_year,
        ...
        insert_job(
            ...
            JOB_STATUS_DICT["finished"],
            JOB_TYPE_DICT["csv_record_validation"],
            self.test_monthly_submission_id,
            num_valid_rows=1,
        )
        insert_job(
            self.session,
        ...
        insert_job(
            ...
            JOB_STATUS_DICT["finished"],
            JOB_TYPE_DICT["csv_record_validation"],
            self.dup_test_monthly_submission_id,
            num_valid_rows=1,
        )
        insert_job(
            self.session,
    ...
    def test_publish_dabs_submission(self):
        ...
        post_json = {"submission_id": self.test_published_submission_id}
        response = self.app.post_json(
            "/v1/publish_dabs_submission/", post_json, headers={"x-session-id": self.session_id}, expect_errors=True
        )
        self.assertEqual(
            response.json["message"],
            "Quarterly submissions cannot be published separate from"
        ...
        self.assertEqual(
            response.json["message"],
            "Submissions that have been certified cannot be republished"
    ...
    def test_certify_dabs_submission(self):
        ...
        post_json = {"submission_id": self.test_published_submission_id}
        response = self.app.post_json(
            "/v1/certify_dabs_submission/", post_json, headers={"x-session-id": self.session_id}, expect_errors=True
        )
        self.assertEqual(
            response.json["message"],
            "Quarterly submissions cannot be certified separate from"
        ...
        self.assertEqual(
            response.json["message"],
            "Submissions that have been certified cannot be recertified"
            " separately. Use the publish_and_certify_dabs_submission endpoint"
            " to recertify.",
        )
        ...
        self.assertEqual(
            response.json["message"],
            "Submissions must be published before certification. Use the"
    ...
    def test_list_history(self):
        ...
        response = self.app.get(
            "/v1/list_history/", params, headers={"x-session-id": self.session_id}, expect_errors=True
        )
        self.assertEqual(response.status_code, 400)
    ...
    def test_get_submitted_published_file(self):
        ...
        published_files_history = (
            sess.query(PublishedFilesHistory)
            .filter_by(certify_history_id=self.test_certify_history_id, file_type_id=FILE_TYPE_DICT["appropriations"])
            .one()
        )
        published_files_history_cross = (
            sess.query(PublishedFilesHistory)
            .filter_by(certify_history_id=self.test_certify_history_id, file_type_id=None)
            .one()
        )
        ...
        response = self.app.get(
            "/v1/get_submitted_published_file/", params, headers={"x-session-id": self.session_id}, expect_errors=True
        )
        self.assertEqual(response.status_code, 400)
    ...
    def test_get_published_file(self):
        ...
        published_files_history_d = (
            sess.query(PublishedFilesHistory)
            .filter_by(
                certify_history_id=self.test_certify_history_id, file_type_id=FILE_TYPE_DICT["award_procurement"]
            )
            .one()
        )
        published_files_history_cross = (
        ...
        # valid warning file
        params = {
            "submission_id": self.test_published_submission_id,
            "is_warning": True,
        ...
        response = self.app.get(
            "/v1/get_published_file/", params, headers={"x-session-id": self.session_id}, expect_errors=True
        )
        self.assertEqual(response.status_code, 400)
        self.assertEqual(response.json["message"], "Invalid published_files_history_id")
        ...
        params = {
            "submission_id": self.test_monthly_submission_id,
            "is_warning": False,
            "published_files_history_id": published_files_history.published_files_history_id,
        }
        response = self.app.get(
        ...
        self.assertEqual(response.status_code, 400)
        self.assertEqual(
            response.json["message"], "Requested published_files_history_id does not match submission_id provided"
        )
    ...
    def test_fail_revalidate_submission(self):
        ...
        response = self.app.post_json(
            "/v1/restart_validation/", post_json, headers={"x-session-id": self.session_id}, expect_errors=True
        )
        self.assertEqual(response.status_code, 400)
    ...
    def test_submission_report_url(self):
        ...
        params = {"warning": False, "file_type": "appropriations", "submission_id": self.row_error_submission_id}
    ...
    def test_submission_report_url_missing_submission_id(self):
        ...
        params = {"warning": False, "file_type": "executive_compensation"}
    ...
    def test_submission_report_url_invalid_file(self):
        ...
        self.assertEqual(
            response.json["message"],
            "file_type: Must be one of: appropriations, award, award_financial, "
    ...
    def test_submission_report_url_invalid_cross(self):
        ...
        self.assertEqual(
            response.json["message"],
            "cross_type: Must be one of: award, award_financial, " "award_procurement, program_activity.",
        )
    ...
    def test_submission_report_url_valid_type_invalid_pair(self):
        ...
        response = self.app.get(
            "/v1/report_url".format(), params, headers={"x-session-id": self.session_id}, expect_errors=True
        )
        self.assertEqual(response.status_code, 400)
    ...
    def test_submission_zip_url(self):
        ...
        test_certify_hist_id, test_publish_hist_id = self.setup_publication_history(
            self.session, self.test_published_submission_id, **test_files
        )

        params = {"submission_id": self.test_published_submission_id, "publish_history_id": test_publish_hist_id}
        response = self.app.get("/v1/get_submission_zip", params, headers={"x-session-id": self.session_id})
        self.assertEqual(response.status_code, 200)
        self.assertIn("url", response.json)

        params = {"submission_id": self.test_published_submission_id, "certify_history_id": test_certify_hist_id}
        response = self.app.get("/v1/get_submission_zip", params, headers={"x-session-id": self.session_id})
        self.assertEqual(response.status_code, 200)
        self.assertIn("url", response.json)
    ...
    def test_submission_zip_url_invalid(self):
        ...
        params = {"submission_id": self.test_published_submission_id}
        response = self.app.get(
            "/v1/get_submission_zip", params, headers={"x-session-id": self.session_id}, expect_errors=True
        )
        self.assertEqual(response.status_code, 400)
        self.assertEqual(response.json["message"], "A publish_history_id or certify_history_id is required.")
        # FABS
        params = {"submission_id": self.test_fabs_submission_id, "publish_history_id": self.test_publish_history_id}
        response = self.app.get(
            "/v1/get_submission_zip", params, headers={"x-session-id": self.session_id}, expect_errors=True
        )
        self.assertEqual(response.status_code, 400)
        ...
        # Unpublished
        params = {
            "submission_id": self.test_unpublished_submission_id,
        ...
        # Wrong submission id
        params = {
            "submission_id": self.test_published_submission_id + 1,
            "publish_history_id": self.test_publish_history_id,
        }
        response = self.app.get(
            "/v1/get_submission_zip", params, headers={"x-session-id": self.session_id}, expect_errors=True
    ...
    def test_cross_file_status_reset_generate(self):
        ...
        job_4 = insert_job(
            self.session, None, JOB_STATUS_DICT["finished"], JOB_TYPE_DICT["validation"], submission.submission_id
        )

        dep_1 = JobDependency(job_id=job_3.job_id, prerequisite_id=job_2.job_id)
        dep_2 = JobDependency(job_id=job_4.job_id, prerequisite_id=job_3.job_id)
        dep_3 = JobDependency(job_id=job_4.job_id, prerequisite_id=job_1.job_id)
    ...
    def test_cross_file_status_reset_new_upload(self):
        ...
        dep_1 = JobDependency(job_id=job_2.job_id, prerequisite_id=job_1.job_id)
        dep_2 = JobDependency(job_id=job_4.job_id, prerequisite_id=job_3.job_id)
        dep_3 = JobDependency(job_id=job_4.job_id, prerequisite_id=job_2.job_id)
        self.session.add_all([dep_1, dep_2, dep_3])
        self.session.commit()
        ...
        # Call a generation to test resetting the status, make sure the call succeeded
        update_json = {
            "existing_submission_id": submission.submission_id,
            "reporting_period_start_date": "04/2016",
            "reporting_period_end_date": "06/2016",
            "is_quarter": True,
        }
    ...
    def insert_published_files_history(
        cls, sess, ch_id, ph_id, submission_id, file_type=None, filename=None, warning_filename=None, comment=None
    ):
    ...
    @classmethod
    def setup_publication_history(
        cls,
        sess,
        submission_id,
        file_a="path/to/file_a.csv",
        file_a_warn="path/to/warning_file_a.csv",
        file_d1="path/to/file_d1.csv",
        ...
        cls.insert_published_files_history(
            sess, ch.certify_history_id, ph.publish_history_id, submission_id, warning_filename=cross_file
        )
    ...
    def setup_file_generation_submission(cls, sess, submission_id):
        ...
        # Create dependency
        exec_comp_dep = JobDependency(job_id=exec_comp_job.job_id, prerequisite_id=award_roc_val_job.job_id)
    ...
    def setup_submission_with_error(cls, sess, row_error_submission_id):
        ...
        metadata = ErrorMetadata(job_id=job.job_id, occurrences=2, severity_id=RULE_SEVERITY_DICT["fatal"])
        sess.add(metadata)
        sess.commit()
    ...
    def setup_jobs_for_reports(cls, sess, error_report_submission_id):
        ...
        insert_job(
            sess,
            filetype=FILE_TYPE_DICT["program_activity"],
            status=finished,
            type_id=csv_validation,
            submission=error_report_submission_id,
        )
    ...
    def setup_file_data(cls, sess, submission_id):
        ...
        job = insert_job(
            sess, filetype=FILE_TYPE_DICT["award"], status=ready, type_id=csv_validation, submission=submission_id
        )
        # everything is fine
