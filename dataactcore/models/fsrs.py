...
class SAMSubcontract(Base):
    ...
    subaward_report_number = Column(String, index=True)
    unique_award_key = Column(String, index=True)
    date_submitted = Column(Date)
    report_type = Column(String)
    transaction_type = Column(String)
    program_title = Column(String)
    contract_agency_code = Column(String)
    contract_idv_agency_code = Column(String)
    treasury_symbol = Column(String)
    prime_recovery_model_q1 = Column(Boolean)
    prime_recovery_model_q2 = Column(Boolean)
    prime_ppop_address_line1 = Column(String)
    ...
    parent_legal_business_name = Column(String)
    dba_name = Column(String)
    legal_entity_country_code = Column(String)
    legal_entity_country_name = Column(String)
    legal_entity_state_code = Column(String)
    legal_entity_state_name = Column(String)
    legal_entity_address_line1 = Column(String)
    legal_entity_address_line2 = Column(String)
    legal_entity_city_name = Column(String)
    legal_entity_zip_code = Column(String)
    legal_entity_congressional = Column(String)
    ppop_country_code = Column(String)
    ppop_country_name = Column(String)
    ppop_state_code = Column(String)
    ppop_state_name = Column(String)
    ppop_address_line1 = Column(String)
    ppop_city_name = Column(String)
    ppop_zip_code = Column(String)
    ppop_congressional_district = Column(String)
    business_type_codes = Column(ARRAY(Text))
    business_type_names = Column(ARRAY(Text))
    description = Column(String)
    funding_agency_code = Column(String)
    funding_agency_name = Column(String)
    funding_office_code = Column(String)
    funding_office_name = Column(String)
    naics = Column(String)
    recovery_model_q1 = Column(Boolean)
    recovery_model_q2 = Column(Boolean)
    recovery_amount = Column(String)
...
class SAMSubgrant(Base):
    ...
    unique_award_key = Column(String, index=True)
    date_submitted = Column(Date)
    prime_dunsplus4 = Column(String)
    prime_compensation_q1 = Column(Boolean)
    prime_compensation_q2 = Column(Boolean)
    prime_ppop_address_line1 = Column(String)
    report_year = Column(String)
    report_month = Column(String)
    award_number = Column(String)
