...
RULE_SEVERITY = [LookupType(1, "warning", "warning"), LookupType(2, "fatal", "fatal error")]
RULE_SEVERITY_DICT = {item.name: item.id for item in RULE_SEVERITY}

RULE_IMPACT = [LookupType(1, "low", "low"), LookupType(2, "medium", "medium"), LookupType(3, "high", "high")]
