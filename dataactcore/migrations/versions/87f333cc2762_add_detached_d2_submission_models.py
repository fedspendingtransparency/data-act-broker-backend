...
Revision ID: 87f333cc2762
Revises: 4bf29ae16467
Create Date: 2017-01-19 10:01:55.321296

"""

# revision identifiers, used by Alembic.
revision = '87f333cc2762'
...
def upgrade_data_broker():
    ...
    sa.Column('award_submission_id', sa.Integer(), nullable=False),
    sa.Column('award_job_id', sa.Integer(), nullable=False),
    ...
    op.create_index(op.f('ix_detached_award_financial_assistance_award_job_id'), 'detached_award_financial_assistance', ['award_job_id'], unique=False)
    op.create_index(op.f('ix_detached_award_financial_assistance_award_submission_id'), 'detached_award_financial_assistance', ['award_submission_id'], unique=False)
    ...
    op.create_table('sub_tier_submission',
    sa.Column('created_at', sa.DateTime(), nullable=True),
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    sa.Column('subission_sub_tier_affiliation_id', sa.Integer(), nullable=False),
    ...
    sa.PrimaryKeyConstraint('subission_sub_tier_affiliation_id')
    )
...
def downgrade_data_broker():
    ...
    op.drop_table('sub_tier_submission')
    ...
    op.drop_index(op.f('ix_detached_award_financial_assistance_award_submission_id'), table_name='detached_award_financial_assistance')
    op.drop_index(op.f('ix_detached_award_financial_assistance_award_job_id'), table_name='detached_award_financial_assistance')
