...
def upgrade_error_data():
    ...
    op.add_column('error_metadata', sa.Column('created_at', sa.DateTime(), nullable=True))
    op.add_column('error_metadata', sa.Column('updated_at', sa.DateTime(), nullable=True))
...
def downgrade_error_data():
    ...
    op.drop_column('error_metadata', 'updated_at')
    op.drop_column('error_metadata', 'created_at')
    ### end Alembic commands ###
...
def upgrade_job_tracker():
    ...
    op.add_column('job_type', sa.Column('created_at', sa.DateTime(), nullable=True))
    op.add_column('job_type', sa.Column('updated_at', sa.DateTime(), nullable=True))
    ### end Alembic commands ###


def downgrade_job_tracker():
    ### commands auto generated by Alembic - please adjust! ###
    op.drop_column('job_type', 'updated_at')
    op.drop_column('job_type', 'created_at')
