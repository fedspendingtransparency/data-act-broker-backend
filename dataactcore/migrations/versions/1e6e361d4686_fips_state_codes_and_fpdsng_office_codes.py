...
def upgrade_data_broker():
    ...
    op.create_index(op.f('ix_published_award_financial_assistance_legal_entity_city_code'), 'published_award_financial_assistance', ['legal_entity_city_code'], unique=False)
...
def downgrade_data_broker():
    ...
    op.drop_index(op.f('ix_published_award_financial_assistance_legal_entity_city_code'), table_name='published_award_financial_assistance')
