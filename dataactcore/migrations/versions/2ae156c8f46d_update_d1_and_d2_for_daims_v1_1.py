...
def upgrade_data_broker():
    ...
    op.add_column('award_procurement', sa.Column('base_and_exercised_opt_val', sa.Text(), nullable=True))
    ...
    op.add_column('detached_award_procurement', sa.Column('base_and_exercised_opt_val', sa.Text(), nullable=True))
...
def downgrade_data_broker():
    ...
    op.drop_column('detached_award_procurement', 'base_and_exercised_opt_val')
    ...
    op.drop_column('award_procurement', 'base_and_exercised_opt_val')
