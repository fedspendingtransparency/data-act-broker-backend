...
def upgrade_data_broker():
    ...
    op.create_index(op.f('ix_pafa_awarding_office_code_upper'), 'published_award_financial_assistance', [text('UPPER(awarding_office_code)')], unique=False)
    op.create_index(op.f('ix_pafa_funding_office_code_upper'), 'published_award_financial_assistance', [text('UPPER(funding_office_code)')], unique=False)
    # ### end Alembic commands ###


def downgrade_data_broker():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(op.f('ix_pafa_funding_office_code_upper'), table_name='published_award_financial_assistance')
    op.drop_index(op.f('ix_pafa_awarding_office_code_upper'), table_name='published_award_financial_assistance')
