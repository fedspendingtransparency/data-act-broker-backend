...
Revision ID: f2fff76fdc3d
Revises: bcdf1134f0df
Create Date: 2017-10-19 12:02:46.217291

"""

# revision identifiers, used by Alembic.
revision = 'f2fff76fdc3d'
...
def upgrade_data_broker():
    ...
    op.create_index(op.f('ix_file_request_agency_id'), 'file_request', ['agency_id'], unique=False)
...
def downgrade_data_broker():
    ...
    op.drop_index(op.f('ix_file_request_agency_id'), table_name='file_request')
