...
mapping = OrderedDict([
    ...
    ('awardee_or_recipient_uniqu', ['AwardeeOrRecipientUniqueIdentifier', 'AwardeeOrRecipientUniqueIdentifier (9A)']),
    ('awardee_or_recipient_legal', ['AwardeeOrRecipientLegalEntityName', 'AwardeeOrRecipientLegalEntityName (13GG)']),
    ('vendor_doing_as_business_n', ['Vendor Doing As Business Name', 'Vendor Doing As Business Name (13HH)']),
    ('cage_code', ['CAGE Code', 'CAGE Code (9L)']),
    ('ultimate_parent_uei', ['UltimateParentUEI', 'UltimateParentUEI ()']),
    ('ultimate_parent_unique_ide', ['UltimateParentUniqueIdentifier', 'UltimateParentUniqueIdentifier ()']),
    ...
    ('vendor_phone_number', ['Vendor Phone Number', 'Vendor Phone Number (13RR)']),
    ('vendor_fax_number', ['Vendor Fax Number', 'Vendor Fax Number (13SS)']),
    ...
    ('fed_biz_opps', ['FedBizOpps', 'FedBizOpps (10S)']),
    ('fed_biz_opps_description', ['FedBizOppsDescriptionTag', 'FedBizOppsDescriptionTag ()']),
