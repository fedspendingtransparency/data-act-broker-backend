...
mapping = OrderedDict([
    ...
    ('Simplified Procedures for Certain Commercial Items', 'commercial_item_test_progr'),
    ...
    ('Native Hawaiian Organization Owned Firm', 'native_hawaiian_owned_busi'),
    ('Tribally Owned Firm', 'tribally_owned_business'),
    ...
    ('All Awards', 'receives_contracts_and_gra'),
    ...
    ('Foreign Owned', 'foreign_owned_and_located'),
