class ResponseException(Exception):
    ...
    def __init__(self,message,status = 500,errorClass = None,errorType = None, extraInfo = None):
        ...
        self.extraInfo = extraInfo # This can be written to the error DB for some error types
        if(errorClass == None):
