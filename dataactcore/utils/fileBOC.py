...
def ussgl_values(model):
    ...
    ussgl_list = [model.sum_ussgl480100_undelivered_or_cpe, model.sum_ussgl480100_undelivered_or_fyb,
                  model.sum_ussgl480110_rein_undel_ord_cpe, model.sum_ussgl480200_undelivered_or_cpe,
                  ...
                  model.sum_ussgl490100_delivered_orde_fyb, model.sum_ussgl490110_rein_deliv_ord_cpe,
