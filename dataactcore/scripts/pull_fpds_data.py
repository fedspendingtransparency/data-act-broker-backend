...
def parse_fpds_file(f, sess, sub_tier_list, naics_dict, filename=None):
    ...
    all_cols = [
        ...
        "fedbizopps", "research", "statutoryexceptiontofairopportunity", "organizationaltype", "firm8aflag",
        "hubzoneflag", "sdbflag", "issbacertifiedsmalldisadvantagedbusiness", "shelteredworkshopflag", "hbcuflag",
        "educationalinstitutionflag", "womenownedflag", "veteranownedflag", "srdvobflag", "localgovernmentflag",
        "minorityinstitutionflag", "aiobflag", "stategovernmentflag", "federalgovernmentflag",
        "minorityownedbusinessflag", "apaobflag", "tribalgovernmentflag", "baobflag", "naobflag", "saaobflag",
        "nonprofitorganizationflag", "isothernotforprofitorganization", "isforprofitorganization", "isfoundation",
        "haobflag", "ishispanicservicinginstitution", "emergingsmallbusinessflag", "hospitalflag",
        "contractingofficerbusinesssizedetermination", "is1862landgrantcollege", "is1890landgrantcollege",
        "is1994landgrantcollege", "isveterinarycollege", "isveterinaryhospital", "isprivateuniversityorcollege",
        "isschoolofforestry", "isstatecontrolledinstitutionofhigherlearning", "isserviceprovider", "receivescontracts",
        "receivesgrants", "receivescontractsandgrants", "isairportauthority", "iscouncilofgovernments",
