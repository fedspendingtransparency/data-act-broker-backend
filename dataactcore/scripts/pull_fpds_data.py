...
def process_data(data, sess, atom_type, sub_tier_list, county_by_name, county_by_code, state_code_list, country_list,
    ...
    boolean_fields = ['small_business_competitive', 'city_local_government', 'county_local_government',
                      ...
                      'c1994_land_grant_college', 'minority_institution', 'private_university_or_coll',
                      'school_of_forestry', 'state_controlled_instituti', 'tribal_college', 'veterinary_college',
                      'educational_institution', 'alaskan_native_servicing_i', 'community_development_corp',
                      'native_hawaiian_servicing', 'domestic_shelter', 'manufacturer_of_goods', 'hospital_flag',
                      'veterinary_hospital', 'hispanic_servicing_institu', 'foundation', 'woman_owned_business',
                      'minority_owned_business', 'women_owned_small_business', 'economically_disadvantaged',
                      'joint_venture_women_owned', 'joint_venture_economically', 'veteran_owned_business',
                      'service_disabled_veteran_o', 'contracts', 'grants', 'receives_contracts_and_gra',
                      'airport_authority', 'council_of_governments', 'housing_authorities_public', 'interstate_entity',
                      'planning_commission', 'port_authority', 'transit_authority', 'subchapter_s_corporation',
                      'limited_liability_corporat', 'foreign_owned_and_located', 'american_indian_owned_busi',
                      'alaskan_native_owned_corpo', 'indian_tribe_federally_rec', 'native_hawaiian_owned_busi',
