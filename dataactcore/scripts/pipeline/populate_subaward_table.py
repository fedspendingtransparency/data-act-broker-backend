...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "-d",
        "--data_type",
        help="Which data (assistance, contract, or both) to populate." " Defaults to both.",
        required=False,
        default="both",
    ...
    with create_app().app_context():
        ...
        metrics_json = {"script_name": "populate_subaward_table.py", "records_inserted": 0, "start_time": str(now)}
