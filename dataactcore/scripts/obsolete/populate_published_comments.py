...
if __name__ == "__main__":
    ...
    with create_app().app_context():
        ...
        max_publish_history = (
            sess.query(
                func.max(PublishHistory.updated_at).label("max_updated_at"),
        ...
        publish_history_list = (
            ...
            .order_by(Comment.submission_id, Comment.file_type_id)
            .all()
        )
        ...
        sess.query(PublishedComment).filter(PublishedComment.submission_id.in_(submissions_list)).delete(
