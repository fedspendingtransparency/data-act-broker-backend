...
def setupErrorDB( hardReset = False):
    ...
    sqlStatements=[
        ...
        "CREATE TABLE file_status (file_id integer PRIMARY KEY DEFAULT nextval('fileSerial'), job_id integer, filename text, status_id integer REFERENCES status NOT NULL);",
