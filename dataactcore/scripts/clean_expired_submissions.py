...
from dataactcore.models.stagingModels import AwardProcurement, ObjectClassProgramActivity, AwardFinancial
...
def clean_expired_submissions(fy17q1_subs=False):
    ...
    cursor = conn.cursor()
    vacuum_models = [Submission, AwardProcurement, ObjectClassProgramActivity, AwardFinancial, ErrorMetadata]
