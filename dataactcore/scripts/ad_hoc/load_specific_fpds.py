...
def get_param_cols(columns):
    ...
    possible_cols = {
        ...
        "referenced_idv_agency_iden": "REF_IDV_AGENCY_ID",
        "piid": "PIID",
        "award_modification_amendme": "MODIFICATION_NUMBER",
        "parent_award_id": "REF_IDV_PIID",
...
if __name__ == "__main__":
    ...
    with create_app().app_context():
        ...
        sub_tier_list, country_list, state_code_list, county_by_name, county_by_code, exec_comp_dict = create_lookups(
            sess
        )
