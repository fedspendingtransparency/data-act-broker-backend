...
SELECT
    ...
    fsrs_grant.uei AS "awardee_or_recipient_uei",
    ...
    fsrs_grant.ultimate_parent_uei AS "ultimate_parent_uei",
    ...
    fsrs_subgrant.uei AS "sub_awardee_or_recipient_uei",
    ...
    fsrs_subgrant.ultimate_parent_uei AS "sub_ultimate_parent_uei",
