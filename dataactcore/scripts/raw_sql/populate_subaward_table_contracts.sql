...
SELECT
    ...
    fsrs_procurement.uei AS "awardee_or_recipient_uei",
    ...
    fsrs_procurement.ultimate_parent_uei AS "ultimate_parent_uei",
    ...
    fsrs_subcontract.uei AS "sub_awardee_or_recipient_uei",
    ...
    fsrs_subcontract.ultimate_parent_uei AS "sub_ultimate_parent_uei",
