...
SELECT
    ...
    awardee_or_recipient_uei AS "AwardeeOrRecipientUEI",
    ...
    sub_awardee_or_recipient_uei AS "SubAwardeeOrRecipientUEI",
    ...
    sub_ultimate_parent_uei AS "SubAwardeeUltimateParentUEI",
