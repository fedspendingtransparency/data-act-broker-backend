-- For PrimaryPlaceOfPerformanceCode XX#####, XXTS###, XX####T, or XX####R, where PrimaryPlaceOfPerformanceZIP+4 is
-- "city-wide": city code #####, TS###, ####T, or ####R must be valid and exist in the provided state.
WITH fabs41_1_{0} AS
