...
SELECT DISTINCT
    ...
    SUM(COALESCE(sf.amount, 0)) AS "expected_value_GTAS SF133 Line 2004",
    op.sum_amount + SUM(COALESCE(sf.amount, 0)) AS "difference",
...
HAVING sum_amount <> (-1 * SUM(COALESCE(sf.amount, 0)));
