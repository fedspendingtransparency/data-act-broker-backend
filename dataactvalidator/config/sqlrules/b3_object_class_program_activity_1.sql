-- ObligationsUndeliveredOrdersUnpaidTotal (FYB) = USSGL 4801 for the unique combination defined in Rule B19 where
-- PYA = "X". Note for FYB values, only 4801 is expected to have a balance other than zero.
SELECT
    row_number,
