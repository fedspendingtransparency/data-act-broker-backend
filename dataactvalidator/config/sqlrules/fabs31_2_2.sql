...
-- (BusinessTypes includes 'P'). For AssistanceType F003, F004, F005, F006, F007, F008, F009, or F010 if the base award
-- (the earliest record with the same unique award key) has an ActionDate prior to October 1, 2022, this will produce a
...
WHERE (
    COALESCE(assistance_type, '') IN ('F003', 'F004', 'F005', 'F006', 'F007', 'F008', 'F009', 'F010')
