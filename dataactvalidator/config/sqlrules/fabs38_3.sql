-- AwardingOfficeCode must be submitted for new awards (ActionType = A1/A2) or mixed aggregate records (ActionType = G1)
...
WHERE submission_id = {0}
    ...
    AND UPPER(COALESCE(action_type, '')) IN ('A1', 'A2', 'G1')
