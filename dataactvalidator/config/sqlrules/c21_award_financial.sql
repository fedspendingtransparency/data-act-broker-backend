...
SELECT NULL AS "source_row_number",
    ...
    ABS(ussgl480100_undelivered_or_fyb_sum_c) - ABS(ussgl480100_undelivered_or_fyb_sum_b) AS "difference_ussgl480100_undelivered_or_fyb_sum",
    ABS(ussgl480100_undelivered_or_cpe_sum_c) - ABS(ussgl480100_undelivered_or_cpe_sum_b) AS "difference_ussgl480100_undelivered_or_cpe_sum",
    ABS(ussgl483100_undelivered_or_cpe_sum_c) - ABS(ussgl483100_undelivered_or_cpe_sum_b) AS "difference_ussgl483100_undelivered_or_cpe_sum",
    ABS(ussgl488100_upward_adjustm_cpe_sum_c) - ABS(ussgl488100_upward_adjustm_cpe_sum_b) AS "difference_ussgl488100_upward_adjustm_cpe_sum",
    ABS(obligations_undelivered_or_fyb_sum_c) - ABS(obligations_undelivered_or_fyb_sum_b) AS "difference_obligations_undelivered_or_fyb_sum",
    ABS(obligations_undelivered_or_cpe_sum_c) - ABS(obligations_undelivered_or_cpe_sum_b) AS "difference_obligations_undelivered_or_cpe_sum",
    ABS(ussgl490100_delivered_orde_fyb_sum_c) - ABS(ussgl490100_delivered_orde_fyb_sum_b) AS "difference_ussgl490100_delivered_orde_fyb_sum",
    ABS(ussgl490100_delivered_orde_cpe_sum_c) - ABS(ussgl490100_delivered_orde_cpe_sum_b) AS "difference_ussgl490100_delivered_orde_cpe_sum",
    ABS(ussgl493100_delivered_orde_cpe_sum_c) - ABS(ussgl493100_delivered_orde_cpe_sum_b) AS "difference_ussgl493100_delivered_orde_cpe_sum",
    ABS(ussgl498100_upward_adjustm_cpe_sum_c) - ABS(ussgl498100_upward_adjustm_cpe_sum_b) AS "difference_ussgl498100_upward_adjustm_cpe_sum",
    ABS(obligations_delivered_orde_fyb_sum_c) - ABS(obligations_delivered_orde_fyb_sum_b) AS "difference_obligations_delivered_orde_fyb_sum",
    ABS(obligations_delivered_orde_cpe_sum_c) - ABS(obligations_delivered_orde_cpe_sum_b) AS "difference_obligations_delivered_orde_cpe_sum",
    ABS(ussgl480200_undelivered_or_fyb_sum_c) - ABS(ussgl480200_undelivered_or_fyb_sum_b) AS "difference_ussgl480200_undelivered_or_fyb_sum",
    ABS(ussgl480200_undelivered_or_cpe_sum_c) - ABS(ussgl480200_undelivered_or_cpe_sum_b) AS "difference_ussgl480200_undelivered_or_cpe_sum",
    ABS(ussgl483200_undelivered_or_cpe_sum_c) - ABS(ussgl483200_undelivered_or_cpe_sum_b) AS "difference_ussgl483200_undelivered_or_cpe_sum",
    ABS(ussgl488200_upward_adjustm_cpe_sum_c) - ABS(ussgl488200_upward_adjustm_cpe_sum_b) AS "difference_ussgl488200_upward_adjustm_cpe_sum",
    ABS(gross_outlays_undelivered_fyb_sum_c) - ABS(gross_outlays_undelivered_fyb_sum_b) AS "difference_gross_outlays_undelivered_fyb_sum",
    ABS(gross_outlays_undelivered_cpe_sum_c) - ABS(gross_outlays_undelivered_cpe_sum_b) AS "difference_gross_outlays_undelivered_cpe_sum",
    ABS(ussgl490200_delivered_orde_cpe_sum_c) - ABS(ussgl490200_delivered_orde_cpe_sum_b) AS "difference_ussgl490200_delivered_orde_cpe_sum",
    ABS(ussgl490800_authority_outl_fyb_sum_c) - ABS(ussgl490800_authority_outl_fyb_sum_b) AS "difference_ussgl490800_authority_outl_fyb_sum",
    ABS(ussgl490800_authority_outl_cpe_sum_c) - ABS(ussgl490800_authority_outl_cpe_sum_b) AS "difference_ussgl490800_authority_outl_cpe_sum",
    ABS(ussgl498200_upward_adjustm_cpe_sum_c) - ABS(ussgl498200_upward_adjustm_cpe_sum_b) AS "difference_ussgl498200_upward_adjustm_cpe_sum",
    ABS(gross_outlays_delivered_or_fyb_sum_c) - ABS(gross_outlays_delivered_or_fyb_sum_b) AS "difference_gross_outlays_delivered_or_fyb_sum",
    ABS(gross_outlays_delivered_or_cpe_sum_c) - ABS(gross_outlays_delivered_or_cpe_sum_b) AS "difference_gross_outlays_delivered_or_cpe_sum",
    ABS(gross_outlay_amount_by_awa_fyb_sum_c) - ABS(gross_outlay_amount_by_pro_fyb_sum_b) AS "difference_gross_outlay_amount_by_pro_fyb_sum",
    ABS(gross_outlay_amount_by_awa_cpe_sum_c) - ABS(gross_outlay_amount_by_pro_cpe_sum_b) AS "difference_gross_outlay_amount_by_pro_cpe_sum",
    ABS(obligations_incurred_byawa_cpe_sum_c) - ABS(obligations_incurred_by_pr_cpe_sum_b) AS "difference_obligations_incurred_by_pr_cpe_sum",
    ABS(ussgl487100_downward_adjus_cpe_sum_c) - ABS(ussgl487100_downward_adjus_cpe_sum_b) AS "difference_ussgl487100_downward_adjus_cpe_sum",
    ABS(ussgl497100_downward_adjus_cpe_sum_c) - ABS(ussgl497100_downward_adjus_cpe_sum_b) AS "difference_ussgl497100_downward_adjus_cpe_sum",
