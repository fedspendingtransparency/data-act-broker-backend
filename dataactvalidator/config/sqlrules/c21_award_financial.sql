...
SELECT NULL AS "source_row_number",
    ...
    COALESCE(ussgl480100_undelivered_or_fyb_sum_c - ussgl480100_undelivered_or_fyb_sum_b, 0) AS "difference_ussgl480100_undelivered_or_fyb_sum",
    COALESCE(ussgl480100_undelivered_or_cpe_sum_c - ussgl480100_undelivered_or_cpe_sum_b, 0) AS "difference_ussgl480100_undelivered_or_cpe_sum",
    COALESCE(ussgl483100_undelivered_or_cpe_sum_c - ussgl483100_undelivered_or_cpe_sum_b, 0) AS "difference_ussgl483100_undelivered_or_cpe_sum",
    COALESCE(ussgl488100_upward_adjustm_cpe_sum_c - ussgl488100_upward_adjustm_cpe_sum_b, 0) AS "difference_ussgl488100_upward_adjustm_cpe_sum",
    COALESCE(obligations_undelivered_or_fyb_sum_c - obligations_undelivered_or_fyb_sum_b, 0) AS "difference_obligations_undelivered_or_fyb_sum",
    COALESCE(obligations_undelivered_or_cpe_sum_c - obligations_undelivered_or_cpe_sum_b, 0) AS "difference_obligations_undelivered_or_cpe_sum",
    COALESCE(ussgl490100_delivered_orde_fyb_sum_c - ussgl490100_delivered_orde_fyb_sum_b, 0) AS "difference_ussgl490100_delivered_orde_fyb_sum",
    COALESCE(ussgl490100_delivered_orde_cpe_sum_c - ussgl490100_delivered_orde_cpe_sum_b, 0) AS "difference_ussgl490100_delivered_orde_cpe_sum",
    COALESCE(ussgl493100_delivered_orde_cpe_sum_c - ussgl493100_delivered_orde_cpe_sum_b, 0) AS "difference_ussgl493100_delivered_orde_cpe_sum",
    COALESCE(ussgl498100_upward_adjustm_cpe_sum_c - ussgl498100_upward_adjustm_cpe_sum_b, 0) AS "difference_ussgl498100_upward_adjustm_cpe_sum",
    COALESCE(obligations_delivered_orde_fyb_sum_c - obligations_delivered_orde_fyb_sum_b, 0) AS "difference_obligations_delivered_orde_fyb_sum",
    COALESCE(obligations_delivered_orde_cpe_sum_c - obligations_delivered_orde_cpe_sum_b, 0) AS "difference_obligations_delivered_orde_cpe_sum",
    COALESCE(ussgl480200_undelivered_or_fyb_sum_c - ussgl480200_undelivered_or_fyb_sum_b, 0) AS "difference_ussgl480200_undelivered_or_fyb_sum",
    COALESCE(ussgl480200_undelivered_or_cpe_sum_c - ussgl480200_undelivered_or_cpe_sum_b, 0) AS "difference_ussgl480200_undelivered_or_cpe_sum",
    COALESCE(ussgl483200_undelivered_or_cpe_sum_c - ussgl483200_undelivered_or_cpe_sum_b, 0) AS "difference_ussgl483200_undelivered_or_cpe_sum",
    COALESCE(ussgl488200_upward_adjustm_cpe_sum_c - ussgl488200_upward_adjustm_cpe_sum_b, 0) AS "difference_ussgl488200_upward_adjustm_cpe_sum",
    COALESCE(gross_outlays_undelivered_fyb_sum_c - gross_outlays_undelivered_fyb_sum_b, 0) AS "difference_gross_outlays_undelivered_fyb_sum",
    COALESCE(gross_outlays_undelivered_cpe_sum_c - gross_outlays_undelivered_cpe_sum_b, 0) AS "difference_gross_outlays_undelivered_cpe_sum",
    COALESCE(ussgl490200_delivered_orde_cpe_sum_c - ussgl490200_delivered_orde_cpe_sum_b, 0) AS "difference_ussgl490200_delivered_orde_cpe_sum",
    COALESCE(ussgl490800_authority_outl_fyb_sum_c - ussgl490800_authority_outl_fyb_sum_b, 0) AS "difference_ussgl490800_authority_outl_fyb_sum",
    COALESCE(ussgl490800_authority_outl_cpe_sum_c - ussgl490800_authority_outl_cpe_sum_b, 0) AS "difference_ussgl490800_authority_outl_cpe_sum",
    COALESCE(ussgl498200_upward_adjustm_cpe_sum_c - ussgl498200_upward_adjustm_cpe_sum_b, 0) AS "difference_ussgl498200_upward_adjustm_cpe_sum",
    COALESCE(gross_outlays_delivered_or_fyb_sum_c - gross_outlays_delivered_or_fyb_sum_b, 0) AS "difference_gross_outlays_delivered_or_fyb_sum",
    COALESCE(gross_outlays_delivered_or_cpe_sum_c - gross_outlays_delivered_or_cpe_sum_b, 0) AS "difference_gross_outlays_delivered_or_cpe_sum",
    COALESCE(gross_outlay_amount_by_awa_fyb_sum_c - gross_outlay_amount_by_pro_fyb_sum_b, 0) AS "difference_gross_outlay_amount_by_pro_fyb_sum",
    COALESCE(gross_outlay_amount_by_awa_cpe_sum_c - gross_outlay_amount_by_pro_cpe_sum_b, 0) AS "difference_gross_outlay_amount_by_pro_cpe_sum",
    COALESCE(obligations_incurred_byawa_cpe_sum_c - obligations_incurred_by_pr_cpe_sum_b, 0) AS "difference_obligations_incurred_by_pr_cpe_sum",
    COALESCE(ussgl487100_downward_adjus_cpe_sum_c - ussgl487100_downward_adjus_cpe_sum_b, 0) AS "difference_ussgl487100_downward_adjus_cpe_sum",
    COALESCE(ussgl497100_downward_adjus_cpe_sum_c - ussgl497100_downward_adjus_cpe_sum_b, 0) AS "difference_ussgl497100_downward_adjus_cpe_sum",
    COALESCE(ussgl487200_downward_adjus_cpe_sum_c - ussgl487200_downward_adjus_cpe_sum_b, 0) AS "difference_ussgl487200_downward_adjus_cpe_sum",
    COALESCE(ussgl497200_downward_adjus_cpe_sum_c - ussgl497200_downward_adjus_cpe_sum_b, 0) AS "difference_ussgl497200_downward_adjus_cpe_sum",
    COALESCE(deobligations_recov_by_awa_cpe_sum_c - deobligations_recov_by_pro_cpe_sum_b, 0) AS "difference_deobligations_recov_by_pro_cpe_sum",
