...
SELECT
    ...
    SUM(COALESCE(sf.amount, 0)) AS "expected_value_GTAS SF133 Line 1910",
    approp.total_budgetary_resources_cpe - SUM(COALESCE(sf.amount, 0)) AS "difference",
...
GROUP BY approp.row_number,
    approp.total_budgetary_resources_cpe,
    approp.display_tas
HAVING approp.total_budgetary_resources_cpe <> SUM(COALESCE(sf.amount, 0));
