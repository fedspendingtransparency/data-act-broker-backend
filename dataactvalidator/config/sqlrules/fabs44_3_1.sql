...
-- LegalEntityZIP5. Data with an ActionDate before 20230103 (the date the 2020 redistricting took full effect) will be
-- evaluated based on the USPS source data from prior to the 2020 redistricting. The LegalEntityCongressionalDistrict
-- may be 90 if the state has more than one congressional district.
