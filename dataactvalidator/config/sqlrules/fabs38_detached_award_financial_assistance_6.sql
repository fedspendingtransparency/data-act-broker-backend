-- AwardingOfficeCode should be submitted for new awards (ActionType = A or blank) whose ActionDate is on or after October 1,
-- 2018, and whose CorrectionDeleteIndicator is either Blank or C.
