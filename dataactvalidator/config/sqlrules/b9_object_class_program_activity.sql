...
WHERE (sub.reporting_fiscal_year, sub.reporting_fiscal_period) NOT IN (('2017', 6), ('2017', 9))
    ...
    AND (op.program_activity_code <> '0000'
        ...
        OR (is_zero(op.deobligations_recov_by_pro_cpe) + is_zero(op.gross_outlay_amount_by_pro_cpe) +
            ...
            is_zero(op.ussgl480110_rein_undel_ord_cpe) + is_zero(op.ussgl480200_undelivered_or_cpe) +
            is_zero(op.ussgl480200_undelivered_or_fyb) + is_zero(op.ussgl480210_rein_undel_obs_cpe) +
            ...
            is_zero(op.ussgl490110_rein_deliv_ord_cpe) + is_zero(op.ussgl490200_delivered_orde_cpe) +
