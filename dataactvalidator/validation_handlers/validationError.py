class ValidationError:
    ...
    type_error_msg = 'The value provided was of the wrong type. Note that all type errors in a line' \
    ...
    blank_file_error_msg = 'File does not contain data. For files A and B, this must be addressed prior to'\
                           ' publication/certification. Blank file C does not prevent publication/certification.'
    blank_file_error = 14
    # Create dict of error types
    error_dict = {type_error: type_error_msg, required_error: required_error_msg, value_error: value_error_msg,
                  header_error: header_error_msg, read_error: read_error_msg, write_error: write_error_msg,
                  unknown_error: unknown_error_msg, single_row: single_row_msg, job_error: job_error_msg,
                  length_error: length_error_msg, encoding_error: encoding_error_msg,
                  row_count_error: row_count_error_msg, file_type_error: file_type_error_msg,
                  field_format_error: field_format_error_msg, blank_file_error: blank_file_error_msg}
    error_type_dict = {type_error: 'type_error', required_error: 'required_error', value_error: 'value_error',
                       header_error: 'header_error', read_error: 'read_error', write_error: 'write_error',
                       unknown_error: 'unknown_error', single_row: 'single_row_error', job_error: 'job_error',
                       length_error: 'length_error', encoding_error: 'encoding_error',
                       row_count_error: 'row_count_error', file_type_error: 'file_type_error',
                       field_format_error: 'field_format_error', blank_file_error: 'blank_file_error'}
