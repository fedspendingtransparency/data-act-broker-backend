...
def write_query_to_file(
    sess, query, local_filename, header=None, generate_headers=False, generate_string=True, file_format="csv"
):
    ...
    temp_sql_file, temp_sql_file_path = generate_temp_query_file(
        raw_query, header=generate_headers, delimiter=delimiter
    )
