...
setup(
    ...
    dependency_links=[
      'git+https://git@github.com/fedspendingtransparency/data-act-broker#egg=data-act-broker',
      'git+https://git@github.com/fedspendingtransparency/data-act-validator#egg=data-act-validator',
    ],
)
