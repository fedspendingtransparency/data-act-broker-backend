...
# Create tables
connection.execute("CREATE SEQUENCE jobIdSerial START 1")
connection.execute("CREATE TABLE job_status (job_id integer PRIMARY KEY DEFAULT nextval('jobIdSerial'), filename text, status_id integer NOT NULL, type_id integer NOT NULL, resource_id integer NOT NULL)")
